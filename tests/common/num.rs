...
//! 2. rename `pub struct rosidl_message_type_support_t`
//! 3. insert `use safe_drive::rcl::rosidl_message_type_support_t;`

use safe_drive::rcl::rosidl_message_type_support_t;
