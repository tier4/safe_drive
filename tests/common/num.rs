...
fn bindgen_test_layout_example_msg__msg__Num() {
    ...
    fn test_field_num() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<example_msg__msg__Num>::uninit();
                let ptr = uninit.as_ptr();
...
fn bindgen_test_layout_example_msg__msg__Num__Sequence() {
    ...
    fn test_field_data() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<example_msg__msg__Num__Sequence>::uninit();
                let ptr = uninit.as_ptr();
...
extern "C" {
    #[doc = " Initialize msg/Num message."]
    #[doc = "**"]
...
extern "C" {
    #[doc = " Copy an array of msg/Num messages."]
    #[doc = "**"]
    #[doc = "* This functions performs a deep copy, as opposed to the shallow copy that"]
    #[doc = "* plain assignment yields."]
    #[doc = "*"]
