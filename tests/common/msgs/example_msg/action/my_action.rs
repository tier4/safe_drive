...
use safe_drive::{
    msg::{builtin_interfaces, unique_identifier_msgs, ActionMsg, ServiceMsg, TypeSupport},
    rcl,
};
...
impl ServiceMsg for MyAction_SendGoal {
...
impl ServiceMsg for MyAction_GetResult {
