...
fn bindgen_test_layout_example_msg__srv__AddThreeInts_Request() {
    ...
    fn test_field_a() {
        assert_eq!(
            unsafe {
                let uninit =
                    ::std::mem::MaybeUninit::<example_msg__srv__AddThreeInts_Request>::uninit();
                let ptr = uninit.as_ptr();
        ...
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<
                    example_msg__srv__AddThreeInts_Request__Sequence,
                >::uninit();
                let ptr = uninit.as_ptr();
...
fn bindgen_test_layout_example_msg__srv__AddThreeInts_Response() {
    ...
    fn test_field_sum() {
        assert_eq!(
            unsafe {
                let uninit =
                    ::std::mem::MaybeUninit::<example_msg__srv__AddThreeInts_Response>::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).sum) as usize - ptr as usize
            },
            0usize,
            concat!(
                "Offset of field: ",
...
fn bindgen_test_layout_example_msg__srv__AddThreeInts_Response__Sequence() {
    ...
    fn test_field_data() {
        assert_eq!(
            unsafe {
                let uninit = ::std::mem::MaybeUninit::<
                    example_msg__srv__AddThreeInts_Response__Sequence,
                >::uninit();
                let ptr = uninit.as_ptr();
                ::std::ptr::addr_of!((*ptr).data) as usize - ptr as usize
            },
...
extern "C" {
    #[doc = " Check for srv/AddThreeInts message equality."]
    #[doc = "**"]
...
extern "C" {
    #[doc = " Copy a srv/AddThreeInts message."]
    #[doc = "**"]
...
extern "C" {
    #[doc = " Check for srv/AddThreeInts message array equality."]
    #[doc = "**"]
...
extern "C" {
    #[doc = " Copy an array of srv/AddThreeInts messages."]
    #[doc = "**"]
    #[doc = "* This functions performs a deep copy, as opposed to the shallow copy that"]
    #[doc = "* plain assignment yields."]
    #[doc = "*"]
