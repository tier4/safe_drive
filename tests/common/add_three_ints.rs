//! # Step to generate Rust from C.
//!
//! 1. Generate Rust file by using bindgen
//! 2. rename `pub struct rosidl_service_type_support_t`
//! 3. rename `pub struct rosidl_message_type_support_t`
//! 4. insert `use safe_drive::rcl::{rosidl_message_type_support_t, rosidl_service_type_support_t};`

use safe_drive::rcl::{rosidl_message_type_support_t, rosidl_service_type_support_t};
...
extern "C" {
    #[doc = " Initialize srv/AddThreeInts message."]
    #[doc = "**"]
...
extern "C" {
    #[doc = " Finalize srv/AddThreeInts message."]
    #[doc = "**"]
...
extern "C" {
    #[doc = " Create srv/AddThreeInts message."]
    #[doc = "**"]
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct rosidl_message_type_support_t_ {
...
#[repr(C)]
#[derive(Debug, Copy, Clone)]
pub struct rosidl_service_type_support_t_ {
    #[doc = " String identifier for the type_support."]
    pub typesupport_identifier: *const ::std::os::raw::c_char,
