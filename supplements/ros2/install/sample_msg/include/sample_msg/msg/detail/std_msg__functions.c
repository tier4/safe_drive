...
#include "sample_msg/msg/detail/std_msg__functions.h"
...
bool
sample_msg__msg__StdMsg__init(sample_msg__msg__StdMsg * msg)
{
  if (!msg) {
    return false;
  }
  ...
  if (!rosidl_runtime_c__String__init(&msg->l)) {
    sample_msg__msg__StdMsg__fini(msg);
    return false;
  }
  // o
...
void
sample_msg__msg__StdMsg__fini(sample_msg__msg__StdMsg * msg)
{
  if (!msg) {
    return;
  }
...
bool
sample_msg__msg__StdMsg__are_equal(const sample_msg__msg__StdMsg * lhs, const sample_msg__msg__StdMsg * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
sample_msg__msg__StdMsg__copy(
  const sample_msg__msg__StdMsg * input,
  sample_msg__msg__StdMsg * output)
{
  if (!input || !output) {
    return false;
  }
...
sample_msg__msg__StdMsg *
sample_msg__msg__StdMsg__create()
{
  sample_msg__msg__StdMsg * msg = (sample_msg__msg__StdMsg *)malloc(sizeof(sample_msg__msg__StdMsg));
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(sample_msg__msg__StdMsg));
  bool success = sample_msg__msg__StdMsg__init(msg);
  if (!success) {
    free(msg);
    return NULL;
  }
...
void
sample_msg__msg__StdMsg__destroy(sample_msg__msg__StdMsg * msg)
{
  if (msg) {
    sample_msg__msg__StdMsg__fini(msg);
  }
...
bool
sample_msg__msg__StdMsg__Sequence__init(sample_msg__msg__StdMsg__Sequence * array, size_t size)
{
  if (!array) {
    return false;
  }
  sample_msg__msg__StdMsg * data = NULL;
  if (size) {
    data = (sample_msg__msg__StdMsg *)calloc(size, sizeof(sample_msg__msg__StdMsg));
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = sample_msg__msg__StdMsg__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        sample_msg__msg__StdMsg__fini(&data[i - 1]);
      }
      free(data);
      return false;
    }
...
void
sample_msg__msg__StdMsg__Sequence__fini(sample_msg__msg__StdMsg__Sequence * array)
{
  if (!array) {
    return;
  }
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      sample_msg__msg__StdMsg__fini(&array->data[i]);
    }
    free(array->data);
    array->data = NULL;
    array->size = 0;
...
sample_msg__msg__StdMsg__Sequence *
sample_msg__msg__StdMsg__Sequence__create(size_t size)
{
  sample_msg__msg__StdMsg__Sequence * array = (sample_msg__msg__StdMsg__Sequence *)malloc(sizeof(sample_msg__msg__StdMsg__Sequence));
  if (!array) {
    return NULL;
  }
  bool success = sample_msg__msg__StdMsg__Sequence__init(array, size);
  if (!success) {
    free(array);
    return NULL;
  }
...
void
sample_msg__msg__StdMsg__Sequence__destroy(sample_msg__msg__StdMsg__Sequence * array)
{
  if (array) {
    sample_msg__msg__StdMsg__Sequence__fini(array);
  }
  free(array);
}

bool
sample_msg__msg__StdMsg__Sequence__are_equal(const sample_msg__msg__StdMsg__Sequence * lhs, const sample_msg__msg__StdMsg__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!sample_msg__msg__StdMsg__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
sample_msg__msg__StdMsg__Sequence__copy(
  const sample_msg__msg__StdMsg__Sequence * input,
  sample_msg__msg__StdMsg__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(sample_msg__msg__StdMsg);
    sample_msg__msg__StdMsg * data =
      (sample_msg__msg__StdMsg *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!sample_msg__msg__StdMsg__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          sample_msg__msg__StdMsg__fini(&data[i]);
        }
        free(data);
        return false;
      }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!sample_msg__msg__StdMsg__copy(
