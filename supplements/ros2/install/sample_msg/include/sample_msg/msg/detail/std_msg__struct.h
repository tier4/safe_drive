...
#ifndef SAMPLE_MSG__MSG__DETAIL__STD_MSG__STRUCT_H_
#define SAMPLE_MSG__MSG__DETAIL__STD_MSG__STRUCT_H_
...
enum
{
  sample_msg__msg__StdMsg__XX = 20l
};

/// Constant 'INITIALIZING_VEHICLE'.
static const char * const sample_msg__msg__StdMsg__INITIALIZING_VEHICLE = "InitializingVehicle a\"a";

/// Constant 'WAITING_FOR_ROUTE'.
static const char * const sample_msg__msg__StdMsg__WAITING_FOR_ROUTE = "WaitingForRoute";

/// Constant 'PLANNING'.
static const char * const sample_msg__msg__StdMsg__PLANNING = "Planning";
...
enum
{
  sample_msg__msg__StdMsg__limited__MAX_SIZE = 5
};

// Struct defined in msg/StdMsg in the package sample_msg.
typedef struct sample_msg__msg__StdMsg
{
  bool a;
  int8_t b;
  uint8_t c;
...
// Struct for a sequence of sample_msg__msg__StdMsg.
typedef struct sample_msg__msg__StdMsg__Sequence
{
...
#endif  // SAMPLE_MSG__MSG__DETAIL__STD_MSG__STRUCT_H_
