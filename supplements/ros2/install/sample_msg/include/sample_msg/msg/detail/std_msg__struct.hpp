...
#ifndef SAMPLE_MSG__MSG__DETAIL__STD_MSG__STRUCT_HPP_
#define SAMPLE_MSG__MSG__DETAIL__STD_MSG__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__sample_msg__msg__StdMsg __attribute__((deprecated))
#else
# define DEPRECATED__sample_msg__msg__StdMsg __declspec(deprecated)
#endif
...
struct StdMsg_
{
  using Type = StdMsg_<ContainerAllocator>;

  explicit StdMsg_(rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : q(_init),
    r(_init),
    s(_init),
    t(_init),
  ...
  explicit StdMsg_(const ContainerAllocator & _alloc, rosidl_runtime_cpp::MessageInitialization _init = rosidl_runtime_cpp::MessageInitialization::ALL)
  : l(_alloc),
    p(_alloc),
    q(_alloc, _init),
    r(_alloc, _init),
  ...
  // pointer types
  using RawPtr =
    sample_msg::msg::StdMsg_<ContainerAllocator> *;
  using ConstRawPtr =
    const sample_msg::msg::StdMsg_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<sample_msg::msg::StdMsg_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<sample_msg::msg::StdMsg_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      sample_msg::msg::StdMsg_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<sample_msg::msg::StdMsg_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<sample_msg::msg::StdMsg_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<sample_msg::msg::StdMsg_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<sample_msg::msg::StdMsg_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__sample_msg__msg__StdMsg
    std::shared_ptr<sample_msg::msg::StdMsg_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__sample_msg__msg__StdMsg
    std::shared_ptr<sample_msg::msg::StdMsg_<ContainerAllocator> const>
  ...
  bool operator==(const StdMsg_ & other) const
  {
    if (this->a != other.a) {
      return false;
    }
...
using StdMsg =
  sample_msg::msg::StdMsg_<std::allocator<void>>;

// constant definitions
template<typename ContainerAllocator>
constexpr int32_t StdMsg_<ContainerAllocator>::XX;
template<typename ContainerAllocator>
const std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>
StdMsg_<ContainerAllocator>::INITIALIZING_VEHICLE = "InitializingVehicle a\"a";
template<typename ContainerAllocator>
const std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>
StdMsg_<ContainerAllocator>::WAITING_FOR_ROUTE = "WaitingForRoute";
template<typename ContainerAllocator>
const std::basic_string<char, std::char_traits<char>, typename std::allocator_traits<ContainerAllocator>::template rebind_alloc<char>>
StdMsg_<ContainerAllocator>::PLANNING = "Planning";

}  // namespace msg

}  // namespace sample_msg

#endif  // SAMPLE_MSG__MSG__DETAIL__STD_MSG__STRUCT_HPP_
