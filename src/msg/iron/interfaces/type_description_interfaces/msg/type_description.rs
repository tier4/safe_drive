...
extern "C" {
    ...
    fn type_description_interfaces__msg__TypeDescription__are_equal(
        lhs: *const TypeDescription,
        rhs: *const TypeDescription,
    ) -> bool;
    fn type_description_interfaces__msg__TypeDescription__Sequence__init(
        msg: *mut TypeDescriptionSeqRaw,
        size: usize,
    ) -> bool;
    fn type_description_interfaces__msg__TypeDescription__Sequence__fini(
        msg: *mut TypeDescriptionSeqRaw,
    );
    fn type_description_interfaces__msg__TypeDescription__Sequence__are_equal(
        lhs: *const TypeDescriptionSeqRaw,
        rhs: *const TypeDescriptionSeqRaw,
    ) -> bool;
    fn rosidl_typesupport_c__get_message_type_support_handle__type_description_interfaces__msg__TypeDescription(
...
impl<const N: usize> TypeDescriptionSeq<N> {
    ...
    pub fn new(size: usize) -> Option<Self> {
        ...
        let mut msg: TypeDescriptionSeqRaw =
            unsafe { std::mem::MaybeUninit::zeroed().assume_init() };
        if unsafe {
            type_description_interfaces__msg__TypeDescription__Sequence__init(&mut msg, size)
        } {
            Some(Self {
                data: msg.data,
                size: msg.size,
...
impl PartialEq for TypeDescription {
    fn eq(&self, other: &Self) -> bool {
        unsafe { type_description_interfaces__msg__TypeDescription__are_equal(self, other) }
    }
}
...
impl<const N: usize> PartialEq for TypeDescriptionSeq<N> {
    fn eq(&self, other: &Self) -> bool {
        unsafe {
            let msg1 = TypeDescriptionSeqRaw {
                data: self.data,
                size: self.size,
                capacity: self.capacity,
            };
            let msg2 = TypeDescriptionSeqRaw {
                data: other.data,
                size: other.size,
