...
extern "C" {
    fn type_description_interfaces__srv__GetTypeDescription_Request__init(msg: *mut GetTypeDescriptionRequest) -> bool;
    fn type_description_interfaces__srv__GetTypeDescription_Request__fini(msg: *mut GetTypeDescriptionRequest);
    fn type_description_interfaces__srv__GetTypeDescription_Request__Sequence__init(msg: *mut GetTypeDescriptionRequestSeqRaw, size: usize) -> bool;
    fn type_description_interfaces__srv__GetTypeDescription_Request__Sequence__fini(msg: *mut GetTypeDescriptionRequestSeqRaw);
    fn type_description_interfaces__srv__GetTypeDescription_Response__init(msg: *mut GetTypeDescriptionResponse) -> bool;
    fn type_description_interfaces__srv__GetTypeDescription_Response__fini(msg: *mut GetTypeDescriptionResponse);
    fn type_description_interfaces__srv__GetTypeDescription_Response__Sequence__init(msg: *mut GetTypeDescriptionResponseSeqRaw, size: usize) -> bool;
    fn type_description_interfaces__srv__GetTypeDescription_Response__Sequence__fini(msg: *mut GetTypeDescriptionResponseSeqRaw);
    fn rosidl_typesupport_c__get_service_type_support_handle__type_description_interfaces__srv__GetTypeDescription() -> *const rcl::rosidl_service_type_support_t;
    fn rosidl_typesupport_c__get_message_type_support_handle__type_description_interfaces__srv__GetTypeDescription_Request() -> *const rcl::rosidl_message_type_support_t;
    fn rosidl_typesupport_c__get_message_type_support_handle__type_description_interfaces__srv__GetTypeDescription_Response() -> *const rcl::rosidl_message_type_support_t;
}
...
impl<const N: usize> GetTypeDescriptionRequestSeq<N> {
    ...
    pub fn new(size: usize) -> Option<Self> {
        ...
        let mut msg: GetTypeDescriptionRequestSeqRaw = unsafe { std::mem::MaybeUninit::zeroed().assume_init() };
        if unsafe { type_description_interfaces__srv__GetTypeDescription_Request__Sequence__init(&mut msg, size) } {
    ...
    pub fn null() -> Self {
        let msg: GetTypeDescriptionRequestSeqRaw = unsafe { std::mem::MaybeUninit::zeroed().assume_init() };
...
impl<const N: usize> Drop for GetTypeDescriptionRequestSeq<N> {
    fn drop(&mut self) {
        let mut msg = GetTypeDescriptionRequestSeqRaw{data: self.data, size: self.size, capacity: self.capacity};
        unsafe { type_description_interfaces__srv__GetTypeDescription_Request__Sequence__fini(&mut msg) };
    }
}
...
impl<const N: usize> GetTypeDescriptionResponseSeq<N> {
    ...
    pub fn new(size: usize) -> Option<Self> {
        ...
        let mut msg: GetTypeDescriptionResponseSeqRaw = unsafe { std::mem::MaybeUninit::zeroed().assume_init() };
        if unsafe { type_description_interfaces__srv__GetTypeDescription_Response__Sequence__init(&mut msg, size) } {
            Some(Self {data: msg.data, size: msg.size, capacity: msg.capacity })
        } else {
            None
        }
    ...
    pub fn null() -> Self {
        let msg: GetTypeDescriptionResponseSeqRaw = unsafe { std::mem::MaybeUninit::zeroed().assume_init() };
        Self {data: msg.data, size: msg.size, capacity: msg.capacity }
    }
...
impl<const N: usize> Drop for GetTypeDescriptionResponseSeq<N> {
    fn drop(&mut self) {
        let mut msg = GetTypeDescriptionResponseSeqRaw{data: self.data, size: self.size, capacity: self.capacity};
        unsafe { type_description_interfaces__srv__GetTypeDescription_Response__Sequence__fini(&mut msg) };
    }
}
