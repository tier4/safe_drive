...
extern "C" {
    fn rcl_interfaces__srv__GetLoggerLevels_Request__init(msg: *mut GetLoggerLevelsRequest)
        -> bool;
    fn rcl_interfaces__srv__GetLoggerLevels_Request__fini(msg: *mut GetLoggerLevelsRequest);
    fn rcl_interfaces__srv__GetLoggerLevels_Request__Sequence__init(
        msg: *mut GetLoggerLevelsRequestSeqRaw,
        size: usize,
    ) -> bool;
    fn rcl_interfaces__srv__GetLoggerLevels_Request__Sequence__fini(
        msg: *mut GetLoggerLevelsRequestSeqRaw,
    );
    fn rcl_interfaces__srv__GetLoggerLevels_Response__init(
        msg: *mut GetLoggerLevelsResponse,
    ) -> bool;
    fn rcl_interfaces__srv__GetLoggerLevels_Response__fini(msg: *mut GetLoggerLevelsResponse);
    fn rcl_interfaces__srv__GetLoggerLevels_Response__Sequence__init(
        msg: *mut GetLoggerLevelsResponseSeqRaw,
        size: usize,
    ) -> bool;
    fn rcl_interfaces__srv__GetLoggerLevels_Response__Sequence__fini(
        msg: *mut GetLoggerLevelsResponseSeqRaw,
    );
    fn rosidl_typesupport_c__get_service_type_support_handle__rcl_interfaces__srv__GetLoggerLevels(
    ) -> *const rcl::rosidl_service_type_support_t;
    fn rosidl_typesupport_c__get_message_type_support_handle__rcl_interfaces__srv__GetLoggerLevels_Request(
    ) -> *const rcl::rosidl_message_type_support_t;
    fn rosidl_typesupport_c__get_message_type_support_handle__rcl_interfaces__srv__GetLoggerLevels_Response(
    ) -> *const rcl::rosidl_message_type_support_t;
}
...
impl<const N: usize> GetLoggerLevelsRequestSeq<N> {
    ...
    pub fn new(size: usize) -> Option<Self> {
        ...
        let mut msg: GetLoggerLevelsRequestSeqRaw =
    ...
    pub fn null() -> Self {
        let msg: GetLoggerLevelsRequestSeqRaw =
            unsafe { std::mem::MaybeUninit::zeroed().assume_init() };
        Self {
            data: msg.data,
            size: msg.size,
...
impl<const N: usize> GetLoggerLevelsResponseSeq<N> {
    ...
    pub fn new(size: usize) -> Option<Self> {
        ...
        let mut msg: GetLoggerLevelsResponseSeqRaw =
            unsafe { std::mem::MaybeUninit::zeroed().assume_init() };
    ...
    pub fn null() -> Self {
        let msg: GetLoggerLevelsResponseSeqRaw =
            unsafe { std::mem::MaybeUninit::zeroed().assume_init() };
        Self {
            data: msg.data,
            size: msg.size,
