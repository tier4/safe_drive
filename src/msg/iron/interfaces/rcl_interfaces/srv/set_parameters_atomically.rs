...
extern "C" {
    fn rcl_interfaces__srv__SetParametersAtomically_Request__init(
        msg: *mut SetParametersAtomicallyRequest,
    ) -> bool;
    fn rcl_interfaces__srv__SetParametersAtomically_Request__fini(
        msg: *mut SetParametersAtomicallyRequest,
    );
    fn rcl_interfaces__srv__SetParametersAtomically_Request__Sequence__init(
        msg: *mut SetParametersAtomicallyRequestSeqRaw,
        size: usize,
    ) -> bool;
    ...
    fn rcl_interfaces__srv__SetParametersAtomically_Response__init(
        msg: *mut SetParametersAtomicallyResponse,
    ) -> bool;
    fn rcl_interfaces__srv__SetParametersAtomically_Response__fini(
        msg: *mut SetParametersAtomicallyResponse,
    );
    fn rcl_interfaces__srv__SetParametersAtomically_Response__Sequence__init(
        msg: *mut SetParametersAtomicallyResponseSeqRaw,
        size: usize,
    ) -> bool;
...
impl<const N: usize> SetParametersAtomicallyRequestSeq<N> {
    ...
    pub fn new(size: usize) -> Option<Self> {
        ...
        let mut msg: SetParametersAtomicallyRequestSeqRaw =
            unsafe { std::mem::MaybeUninit::zeroed().assume_init() };
        if unsafe {
            rcl_interfaces__srv__SetParametersAtomically_Request__Sequence__init(&mut msg, size)
        } {
            Some(Self {
                data: msg.data,
                size: msg.size,
...
impl<const N: usize> SetParametersAtomicallyResponseSeq<N> {
    ...
    pub fn new(size: usize) -> Option<Self> {
        ...
        let mut msg: SetParametersAtomicallyResponseSeqRaw =
            unsafe { std::mem::MaybeUninit::zeroed().assume_init() };
        if unsafe {
            rcl_interfaces__srv__SetParametersAtomically_Response__Sequence__init(&mut msg, size)
        } {
            Some(Self {
                data: msg.data,
                size: msg.size,
