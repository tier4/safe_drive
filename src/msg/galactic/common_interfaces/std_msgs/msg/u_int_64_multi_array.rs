...
extern "C" {
    ...
    fn std_msgs__msg__UInt64MultiArray__are_equal(
        lhs: *const UInt64MultiArray,
        rhs: *const UInt64MultiArray,
    ) -> bool;
    fn std_msgs__msg__UInt64MultiArray__Sequence__init(
        msg: *mut UInt64MultiArraySeqRaw,
        size: usize,
    ) -> bool;
    fn std_msgs__msg__UInt64MultiArray__Sequence__fini(msg: *mut UInt64MultiArraySeqRaw);
    fn std_msgs__msg__UInt64MultiArray__Sequence__are_equal(
        lhs: *const UInt64MultiArraySeqRaw,
        rhs: *const UInt64MultiArraySeqRaw,
    ) -> bool;
...
impl<const N: usize> UInt64MultiArraySeq<N> {
    ...
    pub fn new(size: usize) -> Option<Self> {
        ...
        let mut msg: UInt64MultiArraySeqRaw =
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, UInt64MultiArray> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, UInt64MultiArray> {
...
impl PartialEq for UInt64MultiArray {
    fn eq(&self, other: &Self) -> bool {
        unsafe { std_msgs__msg__UInt64MultiArray__are_equal(self, other) }
    }
}
...
impl<const N: usize> PartialEq for UInt64MultiArraySeq<N> {
    fn eq(&self, other: &Self) -> bool {
        unsafe {
            let msg1 = UInt64MultiArraySeqRaw {
                data: self.data,
                size: self.size,
                capacity: self.capacity,
            };
            let msg2 = UInt64MultiArraySeqRaw {
                data: other.data,
                size: other.size,
