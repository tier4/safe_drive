...
extern "C" {
    ...
    fn std_msgs__msg__Float64__Sequence__are_equal(
        lhs: *const Float64SeqRaw,
        rhs: *const Float64SeqRaw,
    ) -> bool;
...
impl<const N: usize> Float64Seq<N> {
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, Float64> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, Float64> {
...
impl PartialEq for Float64 {
    fn eq(&self, other: &Self) -> bool {
        unsafe { std_msgs__msg__Float64__are_equal(self, other) }
    }
}
...
impl<const N: usize> PartialEq for Float64Seq<N> {
    fn eq(&self, other: &Self) -> bool {
        unsafe {
            let msg1 = Float64SeqRaw {
                data: self.data,
                size: self.size,
                capacity: self.capacity,
            };
            let msg2 = Float64SeqRaw {
                data: other.data,
                size: other.size,
