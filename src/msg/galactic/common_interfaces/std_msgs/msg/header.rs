...
extern "C" {
    ...
    fn std_msgs__msg__Header__Sequence__are_equal(
        lhs: *const HeaderSeqRaw,
        rhs: *const HeaderSeqRaw,
    ) -> bool;
...
impl PartialEq for Header {
    fn eq(&self, other: &Self) -> bool {
        unsafe { std_msgs__msg__Header__are_equal(self, other) }
    }
}
...
impl<const N: usize> PartialEq for HeaderSeq<N> {
    fn eq(&self, other: &Self) -> bool {
        unsafe {
            let msg1 = HeaderSeqRaw {
                data: self.data,
                size: self.size,
                capacity: self.capacity,
            };
            let msg2 = HeaderSeqRaw {
                data: other.data,
                size: other.size,
