...
extern "C" {
    ...
    fn std_msgs__msg__UInt8MultiArray__are_equal(
        lhs: *const UInt8MultiArray,
        rhs: *const UInt8MultiArray,
    ) -> bool;
    fn std_msgs__msg__UInt8MultiArray__Sequence__init(
        msg: *mut UInt8MultiArraySeqRaw,
        size: usize,
    ) -> bool;
    fn std_msgs__msg__UInt8MultiArray__Sequence__fini(msg: *mut UInt8MultiArraySeqRaw);
    fn std_msgs__msg__UInt8MultiArray__Sequence__are_equal(
        lhs: *const UInt8MultiArraySeqRaw,
        rhs: *const UInt8MultiArraySeqRaw,
    ) -> bool;
...
impl<const N: usize> UInt8MultiArraySeq<N> {
    ...
    pub fn new(size: usize) -> Option<Self> {
        ...
        let mut msg: UInt8MultiArraySeqRaw =
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, UInt8MultiArray> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, UInt8MultiArray> {
...
impl PartialEq for UInt8MultiArray {
    fn eq(&self, other: &Self) -> bool {
        unsafe { std_msgs__msg__UInt8MultiArray__are_equal(self, other) }
    }
}
...
impl<const N: usize> PartialEq for UInt8MultiArraySeq<N> {
    fn eq(&self, other: &Self) -> bool {
        unsafe {
            let msg1 = UInt8MultiArraySeqRaw {
                data: self.data,
                size: self.size,
                capacity: self.capacity,
            };
            let msg2 = UInt8MultiArraySeqRaw {
                data: other.data,
                size: other.size,
