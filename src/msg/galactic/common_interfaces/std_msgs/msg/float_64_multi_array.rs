...
extern "C" {
    ...
    fn std_msgs__msg__Float64MultiArray__are_equal(
        lhs: *const Float64MultiArray,
        rhs: *const Float64MultiArray,
    ) -> bool;
    fn std_msgs__msg__Float64MultiArray__Sequence__init(
        msg: *mut Float64MultiArraySeqRaw,
        size: usize,
    ) -> bool;
    fn std_msgs__msg__Float64MultiArray__Sequence__fini(msg: *mut Float64MultiArraySeqRaw);
    fn std_msgs__msg__Float64MultiArray__Sequence__are_equal(
        lhs: *const Float64MultiArraySeqRaw,
        rhs: *const Float64MultiArraySeqRaw,
    ) -> bool;
...
impl<const N: usize> Float64MultiArraySeq<N> {
    ...
    pub fn new(size: usize) -> Option<Self> {
        ...
        let mut msg: Float64MultiArraySeqRaw =
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, Float64MultiArray> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, Float64MultiArray> {
...
impl PartialEq for Float64MultiArray {
    fn eq(&self, other: &Self) -> bool {
        unsafe { std_msgs__msg__Float64MultiArray__are_equal(self, other) }
    }
}
...
impl<const N: usize> PartialEq for Float64MultiArraySeq<N> {
    fn eq(&self, other: &Self) -> bool {
        unsafe {
            let msg1 = Float64MultiArraySeqRaw {
                data: self.data,
                size: self.size,
                capacity: self.capacity,
            };
            let msg2 = Float64MultiArraySeqRaw {
                data: other.data,
                size: other.size,
