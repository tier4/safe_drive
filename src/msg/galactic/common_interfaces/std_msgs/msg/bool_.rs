...
extern "C" {
    ...
    fn std_msgs__msg__Bool__Sequence__are_equal(
        lhs: *const BoolSeqRaw,
        rhs: *const BoolSeqRaw,
    ) -> bool;
...
impl<const N: usize> BoolSeq<N> {
    ...
    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, Bool> {
...
impl PartialEq for Bool {
    fn eq(&self, other: &Self) -> bool {
        unsafe { std_msgs__msg__Bool__are_equal(self, other) }
    }
}
