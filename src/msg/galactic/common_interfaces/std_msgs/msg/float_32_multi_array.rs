...
extern "C" {
    ...
    fn std_msgs__msg__Float32MultiArray__are_equal(
        lhs: *const Float32MultiArray,
        rhs: *const Float32MultiArray,
    ) -> bool;
    fn std_msgs__msg__Float32MultiArray__Sequence__init(
        msg: *mut Float32MultiArraySeqRaw,
        size: usize,
    ) -> bool;
    fn std_msgs__msg__Float32MultiArray__Sequence__fini(msg: *mut Float32MultiArraySeqRaw);
    fn std_msgs__msg__Float32MultiArray__Sequence__are_equal(
        lhs: *const Float32MultiArraySeqRaw,
        rhs: *const Float32MultiArraySeqRaw,
    ) -> bool;
...
impl<const N: usize> Float32MultiArraySeq<N> {
    ...
    pub fn new(size: usize) -> Option<Self> {
        ...
        let mut msg: Float32MultiArraySeqRaw =
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, Float32MultiArray> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, Float32MultiArray> {
...
impl PartialEq for Float32MultiArray {
    fn eq(&self, other: &Self) -> bool {
        unsafe { std_msgs__msg__Float32MultiArray__are_equal(self, other) }
    }
}
...
impl<const N: usize> PartialEq for Float32MultiArraySeq<N> {
    fn eq(&self, other: &Self) -> bool {
        unsafe {
            let msg1 = Float32MultiArraySeqRaw {
                data: self.data,
                size: self.size,
                capacity: self.capacity,
            };
            let msg2 = Float32MultiArraySeqRaw {
                data: other.data,
                size: other.size,
