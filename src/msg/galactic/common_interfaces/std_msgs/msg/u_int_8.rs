...
extern "C" {
    ...
    fn std_msgs__msg__UInt8__Sequence__are_equal(
        lhs: *const UInt8SeqRaw,
        rhs: *const UInt8SeqRaw,
    ) -> bool;
...
impl<const N: usize> UInt8Seq<N> {
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, UInt8> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, UInt8> {
...
impl PartialEq for UInt8 {
    fn eq(&self, other: &Self) -> bool {
        unsafe { std_msgs__msg__UInt8__are_equal(self, other) }
    }
}
...
impl<const N: usize> PartialEq for UInt8Seq<N> {
    fn eq(&self, other: &Self) -> bool {
        unsafe {
            let msg1 = UInt8SeqRaw {
                data: self.data,
                size: self.size,
                capacity: self.capacity,
            };
            let msg2 = UInt8SeqRaw {
                data: other.data,
                size: other.size,
