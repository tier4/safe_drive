...
extern "C" {
    ...
    fn std_msgs__msg__UInt32MultiArray__are_equal(
        lhs: *const UInt32MultiArray,
        rhs: *const UInt32MultiArray,
    ) -> bool;
    fn std_msgs__msg__UInt32MultiArray__Sequence__init(
        msg: *mut UInt32MultiArraySeqRaw,
        size: usize,
    ) -> bool;
    fn std_msgs__msg__UInt32MultiArray__Sequence__fini(msg: *mut UInt32MultiArraySeqRaw);
    fn std_msgs__msg__UInt32MultiArray__Sequence__are_equal(
        lhs: *const UInt32MultiArraySeqRaw,
        rhs: *const UInt32MultiArraySeqRaw,
    ) -> bool;
...
impl<const N: usize> UInt32MultiArraySeq<N> {
    ...
    pub fn new(size: usize) -> Option<Self> {
        ...
        let mut msg: UInt32MultiArraySeqRaw =
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, UInt32MultiArray> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, UInt32MultiArray> {
...
impl PartialEq for UInt32MultiArray {
    fn eq(&self, other: &Self) -> bool {
        unsafe { std_msgs__msg__UInt32MultiArray__are_equal(self, other) }
    }
}
...
impl<const N: usize> PartialEq for UInt32MultiArraySeq<N> {
    fn eq(&self, other: &Self) -> bool {
        unsafe {
            let msg1 = UInt32MultiArraySeqRaw {
                data: self.data,
                size: self.size,
                capacity: self.capacity,
            };
            let msg2 = UInt32MultiArraySeqRaw {
                data: other.data,
                size: other.size,
