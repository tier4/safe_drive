...
extern "C" {
    ...
    fn std_msgs__msg__UInt64__Sequence__are_equal(
        lhs: *const UInt64SeqRaw,
        rhs: *const UInt64SeqRaw,
    ) -> bool;
...
impl<const N: usize> UInt64Seq<N> {
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, UInt64> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, UInt64> {
...
impl PartialEq for UInt64 {
    fn eq(&self, other: &Self) -> bool {
        unsafe { std_msgs__msg__UInt64__are_equal(self, other) }
    }
}
...
impl<const N: usize> PartialEq for UInt64Seq<N> {
    fn eq(&self, other: &Self) -> bool {
        unsafe {
            let msg1 = UInt64SeqRaw {
                data: self.data,
                size: self.size,
                capacity: self.capacity,
            };
            let msg2 = UInt64SeqRaw {
                data: other.data,
                size: other.size,
