...
extern "C" {
    ...
    fn std_msgs__msg__ColorRGBA__Sequence__are_equal(
        lhs: *const ColorRGBASeqRaw,
        rhs: *const ColorRGBASeqRaw,
    ) -> bool;
...
impl<const N: usize> ColorRGBASeq<N> {
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, ColorRGBA> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, ColorRGBA> {
...
impl PartialEq for ColorRGBA {
    fn eq(&self, other: &Self) -> bool {
        unsafe { std_msgs__msg__ColorRGBA__are_equal(self, other) }
    }
}
...
impl<const N: usize> PartialEq for ColorRGBASeq<N> {
    fn eq(&self, other: &Self) -> bool {
        unsafe {
            let msg1 = ColorRGBASeqRaw {
                data: self.data,
                size: self.size,
                capacity: self.capacity,
            };
            let msg2 = ColorRGBASeqRaw {
                data: other.data,
                size: other.size,
