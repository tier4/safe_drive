...
extern "C" {
    ...
    fn std_msgs__msg__Empty__Sequence__are_equal(
        lhs: *const EmptySeqRaw,
        rhs: *const EmptySeqRaw,
    ) -> bool;
...
impl<const N: usize> EmptySeq<N> {
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, Empty> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, Empty> {
...
impl PartialEq for Empty {
    fn eq(&self, other: &Self) -> bool {
        unsafe { std_msgs__msg__Empty__are_equal(self, other) }
    }
}
...
impl<const N: usize> PartialEq for EmptySeq<N> {
    fn eq(&self, other: &Self) -> bool {
        unsafe {
            let msg1 = EmptySeqRaw {
                data: self.data,
                size: self.size,
                capacity: self.capacity,
            };
            let msg2 = EmptySeqRaw {
                data: other.data,
                size: other.size,
