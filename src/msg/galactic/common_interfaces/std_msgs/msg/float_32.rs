...
extern "C" {
    ...
    fn std_msgs__msg__Float32__Sequence__are_equal(
        lhs: *const Float32SeqRaw,
        rhs: *const Float32SeqRaw,
    ) -> bool;
...
impl<const N: usize> Float32Seq<N> {
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, Float32> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, Float32> {
...
impl PartialEq for Float32 {
    fn eq(&self, other: &Self) -> bool {
        unsafe { std_msgs__msg__Float32__are_equal(self, other) }
    }
}
...
impl<const N: usize> PartialEq for Float32Seq<N> {
    fn eq(&self, other: &Self) -> bool {
        unsafe {
            let msg1 = Float32SeqRaw {
                data: self.data,
                size: self.size,
                capacity: self.capacity,
            };
            let msg2 = Float32SeqRaw {
                data: other.data,
                size: other.size,
