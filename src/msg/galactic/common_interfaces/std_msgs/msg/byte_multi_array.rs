...
extern "C" {
    ...
    fn std_msgs__msg__ByteMultiArray__are_equal(
        lhs: *const ByteMultiArray,
        rhs: *const ByteMultiArray,
    ) -> bool;
    fn std_msgs__msg__ByteMultiArray__Sequence__init(
        msg: *mut ByteMultiArraySeqRaw,
        size: usize,
    ) -> bool;
    fn std_msgs__msg__ByteMultiArray__Sequence__fini(msg: *mut ByteMultiArraySeqRaw);
    fn std_msgs__msg__ByteMultiArray__Sequence__are_equal(
        lhs: *const ByteMultiArraySeqRaw,
        rhs: *const ByteMultiArraySeqRaw,
    ) -> bool;
...
impl<const N: usize> ByteMultiArraySeq<N> {
    ...
    pub fn new(size: usize) -> Option<Self> {
        ...
        let mut msg: ByteMultiArraySeqRaw =
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, ByteMultiArray> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, ByteMultiArray> {
...
impl PartialEq for ByteMultiArray {
    fn eq(&self, other: &Self) -> bool {
        unsafe { std_msgs__msg__ByteMultiArray__are_equal(self, other) }
    }
}
...
impl<const N: usize> PartialEq for ByteMultiArraySeq<N> {
    fn eq(&self, other: &Self) -> bool {
        unsafe {
            let msg1 = ByteMultiArraySeqRaw {
                data: self.data,
                size: self.size,
                capacity: self.capacity,
            };
            let msg2 = ByteMultiArraySeqRaw {
                data: other.data,
                size: other.size,
