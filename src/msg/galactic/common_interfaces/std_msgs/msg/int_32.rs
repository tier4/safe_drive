...
extern "C" {
    ...
    fn std_msgs__msg__Int32__Sequence__are_equal(
        lhs: *const Int32SeqRaw,
        rhs: *const Int32SeqRaw,
    ) -> bool;
...
impl<const N: usize> Int32Seq<N> {
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, Int32> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, Int32> {
...
impl PartialEq for Int32 {
    fn eq(&self, other: &Self) -> bool {
        unsafe { std_msgs__msg__Int32__are_equal(self, other) }
    }
}
...
impl<const N: usize> PartialEq for Int32Seq<N> {
    fn eq(&self, other: &Self) -> bool {
        unsafe {
            let msg1 = Int32SeqRaw {
                data: self.data,
                size: self.size,
                capacity: self.capacity,
            };
            let msg2 = Int32SeqRaw {
                data: other.data,
                size: other.size,
