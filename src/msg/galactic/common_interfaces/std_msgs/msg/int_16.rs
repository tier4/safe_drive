...
extern "C" {
    ...
    fn std_msgs__msg__Int16__Sequence__are_equal(
        lhs: *const Int16SeqRaw,
        rhs: *const Int16SeqRaw,
    ) -> bool;
...
impl<const N: usize> Int16Seq<N> {
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, Int16> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, Int16> {
...
impl PartialEq for Int16 {
    fn eq(&self, other: &Self) -> bool {
        unsafe { std_msgs__msg__Int16__are_equal(self, other) }
    }
}
...
impl<const N: usize> PartialEq for Int16Seq<N> {
    fn eq(&self, other: &Self) -> bool {
        unsafe {
            let msg1 = Int16SeqRaw {
                data: self.data,
                size: self.size,
                capacity: self.capacity,
            };
            let msg2 = Int16SeqRaw {
                data: other.data,
                size: other.size,
