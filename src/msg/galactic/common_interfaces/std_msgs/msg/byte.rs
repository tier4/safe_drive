...
extern "C" {
    ...
    fn std_msgs__msg__Byte__Sequence__are_equal(
        lhs: *const ByteSeqRaw,
        rhs: *const ByteSeqRaw,
    ) -> bool;
...
impl<const N: usize> ByteSeq<N> {
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, Byte> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, Byte> {
...
impl PartialEq for Byte {
    fn eq(&self, other: &Self) -> bool {
        unsafe { std_msgs__msg__Byte__are_equal(self, other) }
    }
}
