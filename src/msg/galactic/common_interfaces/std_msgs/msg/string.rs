...
extern "C" {
    ...
    fn std_msgs__msg__String__Sequence__are_equal(
        lhs: *const StringSeqRaw,
        rhs: *const StringSeqRaw,
    ) -> bool;
...
impl PartialEq for String {
    fn eq(&self, other: &Self) -> bool {
        unsafe { std_msgs__msg__String__are_equal(self, other) }
    }
}
...
impl<const N: usize> PartialEq for StringSeq<N> {
    fn eq(&self, other: &Self) -> bool {
        unsafe {
            let msg1 = StringSeqRaw {
                data: self.data,
                size: self.size,
                capacity: self.capacity,
            };
            let msg2 = StringSeqRaw {
                data: other.data,
                size: other.size,
