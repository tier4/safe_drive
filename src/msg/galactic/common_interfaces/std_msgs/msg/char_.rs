...
extern "C" {
    ...
    fn std_msgs__msg__Char__Sequence__are_equal(
        lhs: *const CharSeqRaw,
        rhs: *const CharSeqRaw,
    ) -> bool;
...
impl<const N: usize> CharSeq<N> {
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, Char> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, Char> {
...
impl PartialEq for Char {
    fn eq(&self, other: &Self) -> bool {
        unsafe { std_msgs__msg__Char__are_equal(self, other) }
    }
}
