...
extern "C" {
    ...
    fn std_msgs__msg__Int64__Sequence__are_equal(
        lhs: *const Int64SeqRaw,
        rhs: *const Int64SeqRaw,
    ) -> bool;
...
impl<const N: usize> Int64Seq<N> {
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, Int64> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, Int64> {
...
impl PartialEq for Int64 {
    fn eq(&self, other: &Self) -> bool {
        unsafe { std_msgs__msg__Int64__are_equal(self, other) }
    }
}
...
impl<const N: usize> PartialEq for Int64Seq<N> {
    fn eq(&self, other: &Self) -> bool {
        unsafe {
            let msg1 = Int64SeqRaw {
                data: self.data,
                size: self.size,
                capacity: self.capacity,
            };
            let msg2 = Int64SeqRaw {
                data: other.data,
                size: other.size,
