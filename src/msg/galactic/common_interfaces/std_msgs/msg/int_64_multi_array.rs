...
extern "C" {
    ...
    fn std_msgs__msg__Int64MultiArray__are_equal(
        lhs: *const Int64MultiArray,
        rhs: *const Int64MultiArray,
    ) -> bool;
    fn std_msgs__msg__Int64MultiArray__Sequence__init(
        msg: *mut Int64MultiArraySeqRaw,
        size: usize,
    ) -> bool;
    fn std_msgs__msg__Int64MultiArray__Sequence__fini(msg: *mut Int64MultiArraySeqRaw);
    fn std_msgs__msg__Int64MultiArray__Sequence__are_equal(
        lhs: *const Int64MultiArraySeqRaw,
        rhs: *const Int64MultiArraySeqRaw,
    ) -> bool;
...
impl<const N: usize> Int64MultiArraySeq<N> {
    ...
    pub fn new(size: usize) -> Option<Self> {
        ...
        let mut msg: Int64MultiArraySeqRaw =
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, Int64MultiArray> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, Int64MultiArray> {
...
impl PartialEq for Int64MultiArray {
    fn eq(&self, other: &Self) -> bool {
        unsafe { std_msgs__msg__Int64MultiArray__are_equal(self, other) }
    }
}
...
impl<const N: usize> PartialEq for Int64MultiArraySeq<N> {
    fn eq(&self, other: &Self) -> bool {
        unsafe {
            let msg1 = Int64MultiArraySeqRaw {
                data: self.data,
                size: self.size,
                capacity: self.capacity,
            };
            let msg2 = Int64MultiArraySeqRaw {
                data: other.data,
                size: other.size,
