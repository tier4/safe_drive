...
extern "C" {
    ...
    fn std_msgs__msg__UInt16MultiArray__are_equal(
        lhs: *const UInt16MultiArray,
        rhs: *const UInt16MultiArray,
    ) -> bool;
    fn std_msgs__msg__UInt16MultiArray__Sequence__init(
        msg: *mut UInt16MultiArraySeqRaw,
        size: usize,
    ) -> bool;
    fn std_msgs__msg__UInt16MultiArray__Sequence__fini(msg: *mut UInt16MultiArraySeqRaw);
    fn std_msgs__msg__UInt16MultiArray__Sequence__are_equal(
        lhs: *const UInt16MultiArraySeqRaw,
        rhs: *const UInt16MultiArraySeqRaw,
    ) -> bool;
...
impl<const N: usize> UInt16MultiArraySeq<N> {
    ...
    pub fn new(size: usize) -> Option<Self> {
        ...
        let mut msg: UInt16MultiArraySeqRaw =
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, UInt16MultiArray> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, UInt16MultiArray> {
...
impl PartialEq for UInt16MultiArray {
    fn eq(&self, other: &Self) -> bool {
        unsafe { std_msgs__msg__UInt16MultiArray__are_equal(self, other) }
    }
}
...
impl<const N: usize> PartialEq for UInt16MultiArraySeq<N> {
    fn eq(&self, other: &Self) -> bool {
        unsafe {
            let msg1 = UInt16MultiArraySeqRaw {
                data: self.data,
                size: self.size,
                capacity: self.capacity,
            };
            let msg2 = UInt16MultiArraySeqRaw {
                data: other.data,
                size: other.size,
