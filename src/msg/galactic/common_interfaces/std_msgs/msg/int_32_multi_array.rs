...
extern "C" {
    ...
    fn std_msgs__msg__Int32MultiArray__are_equal(
        lhs: *const Int32MultiArray,
        rhs: *const Int32MultiArray,
    ) -> bool;
    fn std_msgs__msg__Int32MultiArray__Sequence__init(
        msg: *mut Int32MultiArraySeqRaw,
        size: usize,
    ) -> bool;
    fn std_msgs__msg__Int32MultiArray__Sequence__fini(msg: *mut Int32MultiArraySeqRaw);
    fn std_msgs__msg__Int32MultiArray__Sequence__are_equal(
        lhs: *const Int32MultiArraySeqRaw,
        rhs: *const Int32MultiArraySeqRaw,
    ) -> bool;
...
impl<const N: usize> Int32MultiArraySeq<N> {
    ...
    pub fn new(size: usize) -> Option<Self> {
        ...
        let mut msg: Int32MultiArraySeqRaw =
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, Int32MultiArray> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, Int32MultiArray> {
...
impl PartialEq for Int32MultiArray {
    fn eq(&self, other: &Self) -> bool {
        unsafe { std_msgs__msg__Int32MultiArray__are_equal(self, other) }
    }
}
...
impl<const N: usize> PartialEq for Int32MultiArraySeq<N> {
    fn eq(&self, other: &Self) -> bool {
        unsafe {
            let msg1 = Int32MultiArraySeqRaw {
                data: self.data,
                size: self.size,
                capacity: self.capacity,
            };
            let msg2 = Int32MultiArraySeqRaw {
                data: other.data,
                size: other.size,
