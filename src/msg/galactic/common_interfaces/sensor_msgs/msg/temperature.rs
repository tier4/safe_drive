...
extern "C" {
    ...
    fn sensor_msgs__msg__Temperature__are_equal(
        lhs: *const Temperature,
        rhs: *const Temperature,
    ) -> bool;
    fn sensor_msgs__msg__Temperature__Sequence__init(
        msg: *mut TemperatureSeqRaw,
        size: usize,
    ) -> bool;
    fn sensor_msgs__msg__Temperature__Sequence__fini(msg: *mut TemperatureSeqRaw);
    fn sensor_msgs__msg__Temperature__Sequence__are_equal(
        lhs: *const TemperatureSeqRaw,
        rhs: *const TemperatureSeqRaw,
    ) -> bool;
...
impl<const N: usize> TemperatureSeq<N> {
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, Temperature> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, Temperature> {
...
impl PartialEq for Temperature {
    fn eq(&self, other: &Self) -> bool {
        unsafe { sensor_msgs__msg__Temperature__are_equal(self, other) }
    }
}
...
impl<const N: usize> PartialEq for TemperatureSeq<N> {
    fn eq(&self, other: &Self) -> bool {
        unsafe {
            let msg1 = TemperatureSeqRaw {
                data: self.data,
                size: self.size,
                capacity: self.capacity,
            };
            let msg2 = TemperatureSeqRaw {
                data: other.data,
                size: other.size,
