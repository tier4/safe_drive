...
extern "C" {
    ...
    fn sensor_msgs__msg__RelativeHumidity__are_equal(
        lhs: *const RelativeHumidity,
        rhs: *const RelativeHumidity,
    ) -> bool;
    fn sensor_msgs__msg__RelativeHumidity__Sequence__init(
        msg: *mut RelativeHumiditySeqRaw,
        size: usize,
    ) -> bool;
    fn sensor_msgs__msg__RelativeHumidity__Sequence__fini(msg: *mut RelativeHumiditySeqRaw);
    fn sensor_msgs__msg__RelativeHumidity__Sequence__are_equal(
        lhs: *const RelativeHumiditySeqRaw,
        rhs: *const RelativeHumiditySeqRaw,
    ) -> bool;
...
impl<const N: usize> RelativeHumiditySeq<N> {
    ...
    pub fn new(size: usize) -> Option<Self> {
        ...
        let mut msg: RelativeHumiditySeqRaw =
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, RelativeHumidity> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, RelativeHumidity> {
...
impl PartialEq for RelativeHumidity {
    fn eq(&self, other: &Self) -> bool {
        unsafe { sensor_msgs__msg__RelativeHumidity__are_equal(self, other) }
    }
}
...
impl<const N: usize> PartialEq for RelativeHumiditySeq<N> {
    fn eq(&self, other: &Self) -> bool {
        unsafe {
            let msg1 = RelativeHumiditySeqRaw {
                data: self.data,
                size: self.size,
                capacity: self.capacity,
            };
            let msg2 = RelativeHumiditySeqRaw {
                data: other.data,
                size: other.size,
