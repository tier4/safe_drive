...
extern "C" {
    ...
    fn sensor_msgs__msg__Image__Sequence__are_equal(
        lhs: *const ImageSeqRaw,
        rhs: *const ImageSeqRaw,
    ) -> bool;
...
impl<const N: usize> ImageSeq<N> {
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, Image> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, Image> {
...
impl PartialEq for Image {
    fn eq(&self, other: &Self) -> bool {
        unsafe { sensor_msgs__msg__Image__are_equal(self, other) }
    }
}
...
impl<const N: usize> PartialEq for ImageSeq<N> {
    fn eq(&self, other: &Self) -> bool {
        unsafe {
            let msg1 = ImageSeqRaw {
                data: self.data,
                size: self.size,
                capacity: self.capacity,
            };
            let msg2 = ImageSeqRaw {
                data: other.data,
                size: other.size,
