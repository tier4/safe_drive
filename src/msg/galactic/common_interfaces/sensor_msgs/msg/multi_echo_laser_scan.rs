...
extern "C" {
    ...
    fn sensor_msgs__msg__MultiEchoLaserScan__are_equal(
        lhs: *const MultiEchoLaserScan,
        rhs: *const MultiEchoLaserScan,
    ) -> bool;
    fn sensor_msgs__msg__MultiEchoLaserScan__Sequence__init(
        msg: *mut MultiEchoLaserScanSeqRaw,
        size: usize,
    ) -> bool;
    fn sensor_msgs__msg__MultiEchoLaserScan__Sequence__fini(msg: *mut MultiEchoLaserScanSeqRaw);
    fn sensor_msgs__msg__MultiEchoLaserScan__Sequence__are_equal(
        lhs: *const MultiEchoLaserScanSeqRaw,
        rhs: *const MultiEchoLaserScanSeqRaw,
    ) -> bool;
...
impl<const N: usize> MultiEchoLaserScanSeq<N> {
    ...
    pub fn new(size: usize) -> Option<Self> {
        ...
        let mut msg: MultiEchoLaserScanSeqRaw =
    ...
    pub fn null() -> Self {
        let msg: MultiEchoLaserScanSeqRaw =
            unsafe { std::mem::MaybeUninit::zeroed().assume_init() };
        Self {
            data: msg.data,
            size: msg.size,
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, MultiEchoLaserScan> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, MultiEchoLaserScan> {
...
impl PartialEq for MultiEchoLaserScan {
    fn eq(&self, other: &Self) -> bool {
        unsafe { sensor_msgs__msg__MultiEchoLaserScan__are_equal(self, other) }
    }
}
...
impl<const N: usize> PartialEq for MultiEchoLaserScanSeq<N> {
    fn eq(&self, other: &Self) -> bool {
        unsafe {
            let msg1 = MultiEchoLaserScanSeqRaw {
                data: self.data,
                size: self.size,
                capacity: self.capacity,
            };
            let msg2 = MultiEchoLaserScanSeqRaw {
                data: other.data,
                size: other.size,
