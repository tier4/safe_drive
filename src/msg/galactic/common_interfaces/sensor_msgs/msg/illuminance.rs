...
extern "C" {
    ...
    fn sensor_msgs__msg__Illuminance__are_equal(
        lhs: *const Illuminance,
        rhs: *const Illuminance,
    ) -> bool;
    fn sensor_msgs__msg__Illuminance__Sequence__init(
        msg: *mut IlluminanceSeqRaw,
        size: usize,
    ) -> bool;
    fn sensor_msgs__msg__Illuminance__Sequence__fini(msg: *mut IlluminanceSeqRaw);
    fn sensor_msgs__msg__Illuminance__Sequence__are_equal(
        lhs: *const IlluminanceSeqRaw,
        rhs: *const IlluminanceSeqRaw,
    ) -> bool;
...
impl<const N: usize> IlluminanceSeq<N> {
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, Illuminance> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, Illuminance> {
...
impl PartialEq for Illuminance {
    fn eq(&self, other: &Self) -> bool {
        unsafe { sensor_msgs__msg__Illuminance__are_equal(self, other) }
    }
}
...
impl<const N: usize> PartialEq for IlluminanceSeq<N> {
    fn eq(&self, other: &Self) -> bool {
        unsafe {
            let msg1 = IlluminanceSeqRaw {
                data: self.data,
                size: self.size,
                capacity: self.capacity,
            };
            let msg2 = IlluminanceSeqRaw {
                data: other.data,
                size: other.size,
