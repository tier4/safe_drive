...
extern "C" {
    ...
    fn sensor_msgs__msg__CameraInfo__are_equal(
        lhs: *const CameraInfo,
        rhs: *const CameraInfo,
    ) -> bool;
    fn sensor_msgs__msg__CameraInfo__Sequence__init(
        msg: *mut CameraInfoSeqRaw,
        size: usize,
    ) -> bool;
    fn sensor_msgs__msg__CameraInfo__Sequence__fini(msg: *mut CameraInfoSeqRaw);
    fn sensor_msgs__msg__CameraInfo__Sequence__are_equal(
        lhs: *const CameraInfoSeqRaw,
        rhs: *const CameraInfoSeqRaw,
    ) -> bool;
...
impl<const N: usize> CameraInfoSeq<N> {
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, CameraInfo> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, CameraInfo> {
...
impl PartialEq for CameraInfo {
    fn eq(&self, other: &Self) -> bool {
        unsafe { sensor_msgs__msg__CameraInfo__are_equal(self, other) }
    }
}
...
impl<const N: usize> PartialEq for CameraInfoSeq<N> {
    fn eq(&self, other: &Self) -> bool {
        unsafe {
            let msg1 = CameraInfoSeqRaw {
                data: self.data,
                size: self.size,
                capacity: self.capacity,
            };
            let msg2 = CameraInfoSeqRaw {
                data: other.data,
                size: other.size,
