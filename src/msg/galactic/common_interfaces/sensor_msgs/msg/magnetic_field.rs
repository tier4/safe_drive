...
extern "C" {
    ...
    fn sensor_msgs__msg__MagneticField__are_equal(
        lhs: *const MagneticField,
        rhs: *const MagneticField,
    ) -> bool;
    fn sensor_msgs__msg__MagneticField__Sequence__init(
        msg: *mut MagneticFieldSeqRaw,
        size: usize,
    ) -> bool;
    fn sensor_msgs__msg__MagneticField__Sequence__fini(msg: *mut MagneticFieldSeqRaw);
    fn sensor_msgs__msg__MagneticField__Sequence__are_equal(
        lhs: *const MagneticFieldSeqRaw,
        rhs: *const MagneticFieldSeqRaw,
    ) -> bool;
...
impl<const N: usize> MagneticFieldSeq<N> {
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, MagneticField> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, MagneticField> {
...
impl<const N: usize> Drop for MagneticFieldSeq<N> {
    fn drop(&mut self) {
        let mut msg = MagneticFieldSeqRaw {
            data: self.data,
            size: self.size,
...
impl PartialEq for MagneticField {
    fn eq(&self, other: &Self) -> bool {
        unsafe { sensor_msgs__msg__MagneticField__are_equal(self, other) }
    }
}
...
impl<const N: usize> PartialEq for MagneticFieldSeq<N> {
    fn eq(&self, other: &Self) -> bool {
        unsafe {
            let msg1 = MagneticFieldSeqRaw {
                data: self.data,
                size: self.size,
                capacity: self.capacity,
            };
            let msg2 = MagneticFieldSeqRaw {
                data: other.data,
                size: other.size,
