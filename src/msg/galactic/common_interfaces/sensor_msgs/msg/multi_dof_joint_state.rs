...
extern "C" {
    ...
    fn sensor_msgs__msg__MultiDOFJointState__are_equal(
        lhs: *const MultiDOFJointState,
        rhs: *const MultiDOFJointState,
    ) -> bool;
    fn sensor_msgs__msg__MultiDOFJointState__Sequence__init(
        msg: *mut MultiDOFJointStateSeqRaw,
        size: usize,
    ) -> bool;
    fn sensor_msgs__msg__MultiDOFJointState__Sequence__fini(msg: *mut MultiDOFJointStateSeqRaw);
    fn sensor_msgs__msg__MultiDOFJointState__Sequence__are_equal(
        lhs: *const MultiDOFJointStateSeqRaw,
        rhs: *const MultiDOFJointStateSeqRaw,
    ) -> bool;
...
impl<const N: usize> MultiDOFJointStateSeq<N> {
    ...
    pub fn new(size: usize) -> Option<Self> {
        ...
        let mut msg: MultiDOFJointStateSeqRaw =
    ...
    pub fn null() -> Self {
        let msg: MultiDOFJointStateSeqRaw =
            unsafe { std::mem::MaybeUninit::zeroed().assume_init() };
        Self {
            data: msg.data,
            size: msg.size,
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, MultiDOFJointState> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, MultiDOFJointState> {
...
impl PartialEq for MultiDOFJointState {
    fn eq(&self, other: &Self) -> bool {
        unsafe { sensor_msgs__msg__MultiDOFJointState__are_equal(self, other) }
    }
}
...
impl<const N: usize> PartialEq for MultiDOFJointStateSeq<N> {
    fn eq(&self, other: &Self) -> bool {
        unsafe {
            let msg1 = MultiDOFJointStateSeqRaw {
                data: self.data,
                size: self.size,
                capacity: self.capacity,
            };
            let msg2 = MultiDOFJointStateSeqRaw {
                data: other.data,
                size: other.size,
