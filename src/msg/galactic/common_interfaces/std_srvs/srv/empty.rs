...
extern "C" {
    ...
    fn std_srvs__srv__Empty_Request__Sequence__init(
        msg: *mut EmptyRequestSeqRaw,
        size: usize,
    ) -> bool;
    ...
    fn std_srvs__srv__Empty_Response__Sequence__init(
        msg: *mut EmptyResponseSeqRaw,
        size: usize,
    ) -> bool;
...
impl<const N: usize> EmptyRequestSeq<N> {
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, EmptyRequest> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, EmptyRequest> {
...
impl<const N: usize> Drop for EmptyRequestSeq<N> {
    fn drop(&mut self) {
        let mut msg = EmptyRequestSeqRaw {
            data: self.data,
            size: self.size,
...
impl<const N: usize> EmptyResponseSeq<N> {
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, EmptyResponse> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, EmptyResponse> {
        self.as_slice_mut().iter_mut()
    }
...
impl<const N: usize> Drop for EmptyResponseSeq<N> {
    fn drop(&mut self) {
        let mut msg = EmptyResponseSeqRaw {
            data: self.data,
            size: self.size,
            capacity: self.capacity,
        };
