...
extern "C" {
    ...
    fn geometry_msgs__msg__TwistWithCovariance__are_equal(
        lhs: *const TwistWithCovariance,
        rhs: *const TwistWithCovariance,
    ) -> bool;
    fn geometry_msgs__msg__TwistWithCovariance__Sequence__init(
        msg: *mut TwistWithCovarianceSeqRaw,
        size: usize,
    ) -> bool;
    fn geometry_msgs__msg__TwistWithCovariance__Sequence__fini(msg: *mut TwistWithCovarianceSeqRaw);
    fn geometry_msgs__msg__TwistWithCovariance__Sequence__are_equal(
        lhs: *const TwistWithCovarianceSeqRaw,
        rhs: *const TwistWithCovarianceSeqRaw,
    ) -> bool;
...
impl<const N: usize> TwistWithCovarianceSeq<N> {
    ...
    pub fn new(size: usize) -> Option<Self> {
        ...
        let mut msg: TwistWithCovarianceSeqRaw =
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, TwistWithCovariance> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, TwistWithCovariance> {
...
impl PartialEq for TwistWithCovariance {
    fn eq(&self, other: &Self) -> bool {
        unsafe { geometry_msgs__msg__TwistWithCovariance__are_equal(self, other) }
    }
}
...
impl<const N: usize> PartialEq for TwistWithCovarianceSeq<N> {
    fn eq(&self, other: &Self) -> bool {
        unsafe {
            let msg1 = TwistWithCovarianceSeqRaw {
                data: self.data,
                size: self.size,
                capacity: self.capacity,
            };
            let msg2 = TwistWithCovarianceSeqRaw {
                data: other.data,
                size: other.size,
