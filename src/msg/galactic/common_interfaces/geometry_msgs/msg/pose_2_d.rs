...
extern "C" {
    ...
    fn geometry_msgs__msg__Pose2D__Sequence__are_equal(
        lhs: *const Pose2DSeqRaw,
        rhs: *const Pose2DSeqRaw,
    ) -> bool;
...
impl<const N: usize> Pose2DSeq<N> {
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, Pose2D> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, Pose2D> {
...
impl PartialEq for Pose2D {
    fn eq(&self, other: &Self) -> bool {
        unsafe { geometry_msgs__msg__Pose2D__are_equal(self, other) }
    }
}
...
impl<const N: usize> PartialEq for Pose2DSeq<N> {
    fn eq(&self, other: &Self) -> bool {
        unsafe {
            let msg1 = Pose2DSeqRaw {
                data: self.data,
                size: self.size,
                capacity: self.capacity,
            };
            let msg2 = Pose2DSeqRaw {
                data: other.data,
                size: other.size,
