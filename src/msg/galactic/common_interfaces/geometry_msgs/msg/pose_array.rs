...
extern "C" {
    ...
    fn geometry_msgs__msg__PoseArray__are_equal(
        lhs: *const PoseArray,
        rhs: *const PoseArray,
    ) -> bool;
    fn geometry_msgs__msg__PoseArray__Sequence__init(
        msg: *mut PoseArraySeqRaw,
        size: usize,
    ) -> bool;
    fn geometry_msgs__msg__PoseArray__Sequence__fini(msg: *mut PoseArraySeqRaw);
    fn geometry_msgs__msg__PoseArray__Sequence__are_equal(
        lhs: *const PoseArraySeqRaw,
        rhs: *const PoseArraySeqRaw,
    ) -> bool;
...
impl<const N: usize> PoseArraySeq<N> {
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, PoseArray> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, PoseArray> {
...
impl PartialEq for PoseArray {
    fn eq(&self, other: &Self) -> bool {
        unsafe { geometry_msgs__msg__PoseArray__are_equal(self, other) }
    }
}
...
impl<const N: usize> PartialEq for PoseArraySeq<N> {
    fn eq(&self, other: &Self) -> bool {
        unsafe {
            let msg1 = PoseArraySeqRaw {
                data: self.data,
                size: self.size,
                capacity: self.capacity,
            };
            let msg2 = PoseArraySeqRaw {
                data: other.data,
                size: other.size,
