...
extern "C" {
    ...
    fn geometry_msgs__msg__WrenchStamped__are_equal(
        lhs: *const WrenchStamped,
        rhs: *const WrenchStamped,
    ) -> bool;
    fn geometry_msgs__msg__WrenchStamped__Sequence__init(
        msg: *mut WrenchStampedSeqRaw,
        size: usize,
    ) -> bool;
    fn geometry_msgs__msg__WrenchStamped__Sequence__fini(msg: *mut WrenchStampedSeqRaw);
    fn geometry_msgs__msg__WrenchStamped__Sequence__are_equal(
        lhs: *const WrenchStampedSeqRaw,
        rhs: *const WrenchStampedSeqRaw,
    ) -> bool;
...
impl<const N: usize> WrenchStampedSeq<N> {
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, WrenchStamped> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, WrenchStamped> {
...
impl<const N: usize> Drop for WrenchStampedSeq<N> {
    fn drop(&mut self) {
        let mut msg = WrenchStampedSeqRaw {
            data: self.data,
            size: self.size,
...
impl PartialEq for WrenchStamped {
    fn eq(&self, other: &Self) -> bool {
        unsafe { geometry_msgs__msg__WrenchStamped__are_equal(self, other) }
    }
}
...
impl<const N: usize> PartialEq for WrenchStampedSeq<N> {
    fn eq(&self, other: &Self) -> bool {
        unsafe {
            let msg1 = WrenchStampedSeqRaw {
                data: self.data,
                size: self.size,
                capacity: self.capacity,
            };
            let msg2 = WrenchStampedSeqRaw {
                data: other.data,
                size: other.size,
