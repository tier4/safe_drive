...
extern "C" {
    ...
    fn geometry_msgs__msg__Inertia__Sequence__are_equal(
        lhs: *const InertiaSeqRaw,
        rhs: *const InertiaSeqRaw,
    ) -> bool;
...
impl<const N: usize> InertiaSeq<N> {
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, Inertia> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, Inertia> {
...
impl PartialEq for Inertia {
    fn eq(&self, other: &Self) -> bool {
        unsafe { geometry_msgs__msg__Inertia__are_equal(self, other) }
    }
}
...
impl<const N: usize> PartialEq for InertiaSeq<N> {
    fn eq(&self, other: &Self) -> bool {
        unsafe {
            let msg1 = InertiaSeqRaw {
                data: self.data,
                size: self.size,
                capacity: self.capacity,
            };
            let msg2 = InertiaSeqRaw {
                data: other.data,
                size: other.size,
