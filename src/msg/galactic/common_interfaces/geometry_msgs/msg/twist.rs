...
extern "C" {
    ...
    fn geometry_msgs__msg__Twist__Sequence__are_equal(
        lhs: *const TwistSeqRaw,
        rhs: *const TwistSeqRaw,
    ) -> bool;
...
impl<const N: usize> TwistSeq<N> {
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, Twist> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, Twist> {
...
impl PartialEq for Twist {
    fn eq(&self, other: &Self) -> bool {
        unsafe { geometry_msgs__msg__Twist__are_equal(self, other) }
    }
}
...
impl<const N: usize> PartialEq for TwistSeq<N> {
    fn eq(&self, other: &Self) -> bool {
        unsafe {
            let msg1 = TwistSeqRaw {
                data: self.data,
                size: self.size,
                capacity: self.capacity,
            };
            let msg2 = TwistSeqRaw {
                data: other.data,
                size: other.size,
