...
extern "C" {
    ...
    fn geometry_msgs__msg__Accel__Sequence__are_equal(
        lhs: *const AccelSeqRaw,
        rhs: *const AccelSeqRaw,
    ) -> bool;
...
impl<const N: usize> AccelSeq<N> {
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, Accel> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, Accel> {
...
impl PartialEq for Accel {
    fn eq(&self, other: &Self) -> bool {
        unsafe { geometry_msgs__msg__Accel__are_equal(self, other) }
    }
}
...
impl<const N: usize> PartialEq for AccelSeq<N> {
    fn eq(&self, other: &Self) -> bool {
        unsafe {
            let msg1 = AccelSeqRaw {
                data: self.data,
                size: self.size,
                capacity: self.capacity,
            };
            let msg2 = AccelSeqRaw {
                data: other.data,
                size: other.size,
