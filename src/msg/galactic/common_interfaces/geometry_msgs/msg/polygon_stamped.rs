...
extern "C" {
    ...
    fn geometry_msgs__msg__PolygonStamped__are_equal(
        lhs: *const PolygonStamped,
        rhs: *const PolygonStamped,
    ) -> bool;
    fn geometry_msgs__msg__PolygonStamped__Sequence__init(
        msg: *mut PolygonStampedSeqRaw,
        size: usize,
    ) -> bool;
    fn geometry_msgs__msg__PolygonStamped__Sequence__fini(msg: *mut PolygonStampedSeqRaw);
    fn geometry_msgs__msg__PolygonStamped__Sequence__are_equal(
        lhs: *const PolygonStampedSeqRaw,
        rhs: *const PolygonStampedSeqRaw,
    ) -> bool;
...
impl<const N: usize> PolygonStampedSeq<N> {
    ...
    pub fn new(size: usize) -> Option<Self> {
        ...
        let mut msg: PolygonStampedSeqRaw =
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, PolygonStamped> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, PolygonStamped> {
...
impl PartialEq for PolygonStamped {
    fn eq(&self, other: &Self) -> bool {
        unsafe { geometry_msgs__msg__PolygonStamped__are_equal(self, other) }
    }
}
...
impl<const N: usize> PartialEq for PolygonStampedSeq<N> {
    fn eq(&self, other: &Self) -> bool {
        unsafe {
            let msg1 = PolygonStampedSeqRaw {
                data: self.data,
                size: self.size,
                capacity: self.capacity,
            };
            let msg2 = PolygonStampedSeqRaw {
                data: other.data,
                size: other.size,
