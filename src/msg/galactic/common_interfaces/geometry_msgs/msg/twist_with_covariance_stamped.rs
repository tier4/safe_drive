...
extern "C" {
    ...
    fn geometry_msgs__msg__TwistWithCovarianceStamped__are_equal(
        lhs: *const TwistWithCovarianceStamped,
        rhs: *const TwistWithCovarianceStamped,
    ) -> bool;
    fn geometry_msgs__msg__TwistWithCovarianceStamped__Sequence__init(
        msg: *mut TwistWithCovarianceStampedSeqRaw,
        size: usize,
    ) -> bool;
    fn geometry_msgs__msg__TwistWithCovarianceStamped__Sequence__fini(
        msg: *mut TwistWithCovarianceStampedSeqRaw,
    );
    fn geometry_msgs__msg__TwistWithCovarianceStamped__Sequence__are_equal(
        lhs: *const TwistWithCovarianceStampedSeqRaw,
        rhs: *const TwistWithCovarianceStampedSeqRaw,
    ) -> bool;
...
impl<const N: usize> TwistWithCovarianceStampedSeq<N> {
    ...
    pub fn new(size: usize) -> Option<Self> {
        ...
        let mut msg: TwistWithCovarianceStampedSeqRaw =
    ...
    pub fn null() -> Self {
        let msg: TwistWithCovarianceStampedSeqRaw =
            unsafe { std::mem::MaybeUninit::zeroed().assume_init() };
        Self {
            data: msg.data,
            size: msg.size,
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, TwistWithCovarianceStamped> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, TwistWithCovarianceStamped> {
...
impl PartialEq for TwistWithCovarianceStamped {
    fn eq(&self, other: &Self) -> bool {
        unsafe { geometry_msgs__msg__TwistWithCovarianceStamped__are_equal(self, other) }
    }
}
...
impl<const N: usize> PartialEq for TwistWithCovarianceStampedSeq<N> {
    fn eq(&self, other: &Self) -> bool {
        unsafe {
            let msg1 = TwistWithCovarianceStampedSeqRaw {
                data: self.data,
                size: self.size,
                capacity: self.capacity,
            };
            let msg2 = TwistWithCovarianceStampedSeqRaw {
                data: other.data,
                size: other.size,
