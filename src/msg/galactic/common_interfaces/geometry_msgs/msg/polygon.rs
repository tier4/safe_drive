...
extern "C" {
    ...
    fn geometry_msgs__msg__Polygon__Sequence__are_equal(
        lhs: *const PolygonSeqRaw,
        rhs: *const PolygonSeqRaw,
    ) -> bool;
...
impl<const N: usize> PolygonSeq<N> {
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, Polygon> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, Polygon> {
...
impl PartialEq for Polygon {
    fn eq(&self, other: &Self) -> bool {
        unsafe { geometry_msgs__msg__Polygon__are_equal(self, other) }
    }
}
...
impl<const N: usize> PartialEq for PolygonSeq<N> {
    fn eq(&self, other: &Self) -> bool {
        unsafe {
            let msg1 = PolygonSeqRaw {
                data: self.data,
                size: self.size,
                capacity: self.capacity,
            };
            let msg2 = PolygonSeqRaw {
                data: other.data,
                size: other.size,
