...
extern "C" {
    ...
    fn geometry_msgs__msg__Point__Sequence__are_equal(
        lhs: *const PointSeqRaw,
        rhs: *const PointSeqRaw,
    ) -> bool;
...
impl<const N: usize> PointSeq<N> {
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, Point> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, Point> {
...
impl PartialEq for Point {
    fn eq(&self, other: &Self) -> bool {
        unsafe { geometry_msgs__msg__Point__are_equal(self, other) }
    }
}
...
impl<const N: usize> PartialEq for PointSeq<N> {
    fn eq(&self, other: &Self) -> bool {
        unsafe {
            let msg1 = PointSeqRaw {
                data: self.data,
                size: self.size,
                capacity: self.capacity,
            };
            let msg2 = PointSeqRaw {
                data: other.data,
                size: other.size,
