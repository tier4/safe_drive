...
extern "C" {
    ...
    fn geometry_msgs__msg__TwistStamped__are_equal(
        lhs: *const TwistStamped,
        rhs: *const TwistStamped,
    ) -> bool;
    fn geometry_msgs__msg__TwistStamped__Sequence__init(
        msg: *mut TwistStampedSeqRaw,
        size: usize,
    ) -> bool;
    fn geometry_msgs__msg__TwistStamped__Sequence__fini(msg: *mut TwistStampedSeqRaw);
    fn geometry_msgs__msg__TwistStamped__Sequence__are_equal(
        lhs: *const TwistStampedSeqRaw,
        rhs: *const TwistStampedSeqRaw,
    ) -> bool;
...
impl<const N: usize> TwistStampedSeq<N> {
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, TwistStamped> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, TwistStamped> {
...
impl<const N: usize> Drop for TwistStampedSeq<N> {
    fn drop(&mut self) {
        let mut msg = TwistStampedSeqRaw {
            data: self.data,
            size: self.size,
...
impl PartialEq for TwistStamped {
    fn eq(&self, other: &Self) -> bool {
        unsafe { geometry_msgs__msg__TwistStamped__are_equal(self, other) }
    }
}
...
impl<const N: usize> PartialEq for TwistStampedSeq<N> {
    fn eq(&self, other: &Self) -> bool {
        unsafe {
            let msg1 = TwistStampedSeqRaw {
                data: self.data,
                size: self.size,
                capacity: self.capacity,
            };
            let msg2 = TwistStampedSeqRaw {
                data: other.data,
                size: other.size,
