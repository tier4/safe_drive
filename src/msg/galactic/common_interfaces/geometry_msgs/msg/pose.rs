...
extern "C" {
    ...
    fn geometry_msgs__msg__Pose__Sequence__are_equal(
        lhs: *const PoseSeqRaw,
        rhs: *const PoseSeqRaw,
    ) -> bool;
...
impl<const N: usize> PoseSeq<N> {
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, Pose> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, Pose> {
...
impl PartialEq for Pose {
    fn eq(&self, other: &Self) -> bool {
        unsafe { geometry_msgs__msg__Pose__are_equal(self, other) }
    }
}
