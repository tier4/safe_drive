...
extern "C" {
    ...
    fn geometry_msgs__msg__Wrench__Sequence__are_equal(
        lhs: *const WrenchSeqRaw,
        rhs: *const WrenchSeqRaw,
    ) -> bool;
...
impl<const N: usize> WrenchSeq<N> {
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, Wrench> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, Wrench> {
...
impl PartialEq for Wrench {
    fn eq(&self, other: &Self) -> bool {
        unsafe { geometry_msgs__msg__Wrench__are_equal(self, other) }
    }
}
...
impl<const N: usize> PartialEq for WrenchSeq<N> {
    fn eq(&self, other: &Self) -> bool {
        unsafe {
            let msg1 = WrenchSeqRaw {
                data: self.data,
                size: self.size,
                capacity: self.capacity,
            };
            let msg2 = WrenchSeqRaw {
                data: other.data,
                size: other.size,
