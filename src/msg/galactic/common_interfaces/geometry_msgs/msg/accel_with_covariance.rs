...
extern "C" {
    ...
    fn geometry_msgs__msg__AccelWithCovariance__are_equal(
        lhs: *const AccelWithCovariance,
        rhs: *const AccelWithCovariance,
    ) -> bool;
    fn geometry_msgs__msg__AccelWithCovariance__Sequence__init(
        msg: *mut AccelWithCovarianceSeqRaw,
        size: usize,
    ) -> bool;
    fn geometry_msgs__msg__AccelWithCovariance__Sequence__fini(msg: *mut AccelWithCovarianceSeqRaw);
    fn geometry_msgs__msg__AccelWithCovariance__Sequence__are_equal(
        lhs: *const AccelWithCovarianceSeqRaw,
        rhs: *const AccelWithCovarianceSeqRaw,
    ) -> bool;
...
impl<const N: usize> AccelWithCovarianceSeq<N> {
    ...
    pub fn new(size: usize) -> Option<Self> {
        ...
        let mut msg: AccelWithCovarianceSeqRaw =
    ...
    pub fn null() -> Self {
        let msg: AccelWithCovarianceSeqRaw =
            unsafe { std::mem::MaybeUninit::zeroed().assume_init() };
        Self {
            data: msg.data,
            size: msg.size,
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, AccelWithCovariance> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, AccelWithCovariance> {
...
impl PartialEq for AccelWithCovariance {
    fn eq(&self, other: &Self) -> bool {
        unsafe { geometry_msgs__msg__AccelWithCovariance__are_equal(self, other) }
    }
}
...
impl<const N: usize> PartialEq for AccelWithCovarianceSeq<N> {
    fn eq(&self, other: &Self) -> bool {
        unsafe {
            let msg1 = AccelWithCovarianceSeqRaw {
                data: self.data,
                size: self.size,
                capacity: self.capacity,
            };
            let msg2 = AccelWithCovarianceSeqRaw {
                data: other.data,
                size: other.size,
