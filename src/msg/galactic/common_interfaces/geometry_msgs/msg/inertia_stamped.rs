...
extern "C" {
    ...
    fn geometry_msgs__msg__InertiaStamped__are_equal(
        lhs: *const InertiaStamped,
        rhs: *const InertiaStamped,
    ) -> bool;
    fn geometry_msgs__msg__InertiaStamped__Sequence__init(
        msg: *mut InertiaStampedSeqRaw,
        size: usize,
    ) -> bool;
    fn geometry_msgs__msg__InertiaStamped__Sequence__fini(msg: *mut InertiaStampedSeqRaw);
    fn geometry_msgs__msg__InertiaStamped__Sequence__are_equal(
        lhs: *const InertiaStampedSeqRaw,
        rhs: *const InertiaStampedSeqRaw,
    ) -> bool;
...
impl<const N: usize> InertiaStampedSeq<N> {
    ...
    pub fn new(size: usize) -> Option<Self> {
        ...
        let mut msg: InertiaStampedSeqRaw =
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, InertiaStamped> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, InertiaStamped> {
...
impl PartialEq for InertiaStamped {
    fn eq(&self, other: &Self) -> bool {
        unsafe { geometry_msgs__msg__InertiaStamped__are_equal(self, other) }
    }
}
...
impl<const N: usize> PartialEq for InertiaStampedSeq<N> {
    fn eq(&self, other: &Self) -> bool {
        unsafe {
            let msg1 = InertiaStampedSeqRaw {
                data: self.data,
                size: self.size,
                capacity: self.capacity,
            };
            let msg2 = InertiaStampedSeqRaw {
                data: other.data,
                size: other.size,
