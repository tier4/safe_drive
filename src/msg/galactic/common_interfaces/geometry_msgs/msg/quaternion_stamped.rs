...
extern "C" {
    ...
    fn geometry_msgs__msg__QuaternionStamped__are_equal(
        lhs: *const QuaternionStamped,
        rhs: *const QuaternionStamped,
    ) -> bool;
    fn geometry_msgs__msg__QuaternionStamped__Sequence__init(
        msg: *mut QuaternionStampedSeqRaw,
        size: usize,
    ) -> bool;
    fn geometry_msgs__msg__QuaternionStamped__Sequence__fini(msg: *mut QuaternionStampedSeqRaw);
    fn geometry_msgs__msg__QuaternionStamped__Sequence__are_equal(
        lhs: *const QuaternionStampedSeqRaw,
        rhs: *const QuaternionStampedSeqRaw,
    ) -> bool;
...
impl<const N: usize> QuaternionStampedSeq<N> {
    ...
    pub fn new(size: usize) -> Option<Self> {
        ...
        let mut msg: QuaternionStampedSeqRaw =
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, QuaternionStamped> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, QuaternionStamped> {
...
impl PartialEq for QuaternionStamped {
    fn eq(&self, other: &Self) -> bool {
        unsafe { geometry_msgs__msg__QuaternionStamped__are_equal(self, other) }
    }
}
...
impl<const N: usize> PartialEq for QuaternionStampedSeq<N> {
    fn eq(&self, other: &Self) -> bool {
        unsafe {
            let msg1 = QuaternionStampedSeqRaw {
                data: self.data,
                size: self.size,
                capacity: self.capacity,
            };
            let msg2 = QuaternionStampedSeqRaw {
                data: other.data,
                size: other.size,
