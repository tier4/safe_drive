...
extern "C" {
    ...
    fn geometry_msgs__msg__TransformStamped__are_equal(
        lhs: *const TransformStamped,
        rhs: *const TransformStamped,
    ) -> bool;
    fn geometry_msgs__msg__TransformStamped__Sequence__init(
        msg: *mut TransformStampedSeqRaw,
        size: usize,
    ) -> bool;
    fn geometry_msgs__msg__TransformStamped__Sequence__fini(msg: *mut TransformStampedSeqRaw);
    fn geometry_msgs__msg__TransformStamped__Sequence__are_equal(
        lhs: *const TransformStampedSeqRaw,
        rhs: *const TransformStampedSeqRaw,
    ) -> bool;
...
impl<const N: usize> TransformStampedSeq<N> {
    ...
    pub fn new(size: usize) -> Option<Self> {
        ...
        let mut msg: TransformStampedSeqRaw =
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, TransformStamped> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, TransformStamped> {
...
impl PartialEq for TransformStamped {
    fn eq(&self, other: &Self) -> bool {
        unsafe { geometry_msgs__msg__TransformStamped__are_equal(self, other) }
    }
}
...
impl<const N: usize> PartialEq for TransformStampedSeq<N> {
    fn eq(&self, other: &Self) -> bool {
        unsafe {
            let msg1 = TransformStampedSeqRaw {
                data: self.data,
                size: self.size,
                capacity: self.capacity,
            };
            let msg2 = TransformStampedSeqRaw {
                data: other.data,
                size: other.size,
