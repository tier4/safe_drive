...
extern "C" {
    ...
    fn trajectory_msgs__msg__MultiDOFJointTrajectoryPoint__fini(
        msg: *mut MultiDOFJointTrajectoryPoint,
    );
    fn trajectory_msgs__msg__MultiDOFJointTrajectoryPoint__are_equal(
        lhs: *const MultiDOFJointTrajectoryPoint,
        rhs: *const MultiDOFJointTrajectoryPoint,
    ) -> bool;
    fn trajectory_msgs__msg__MultiDOFJointTrajectoryPoint__Sequence__init(
        msg: *mut MultiDOFJointTrajectoryPointSeqRaw,
        size: usize,
    ) -> bool;
    fn trajectory_msgs__msg__MultiDOFJointTrajectoryPoint__Sequence__fini(
        msg: *mut MultiDOFJointTrajectoryPointSeqRaw,
    );
    fn trajectory_msgs__msg__MultiDOFJointTrajectoryPoint__Sequence__are_equal(
        lhs: *const MultiDOFJointTrajectoryPointSeqRaw,
        rhs: *const MultiDOFJointTrajectoryPointSeqRaw,
    ) -> bool;
...
impl<const N: usize> MultiDOFJointTrajectoryPointSeq<N> {
    ...
    pub fn new(size: usize) -> Option<Self> {
        ...
        let mut msg: MultiDOFJointTrajectoryPointSeqRaw =
            unsafe { std::mem::MaybeUninit::zeroed().assume_init() };
        if unsafe {
            trajectory_msgs__msg__MultiDOFJointTrajectoryPoint__Sequence__init(&mut msg, size)
        } {
            Some(Self {
                data: msg.data,
                size: msg.size,
    ...
    pub fn as_slice_mut(&mut self) -> &mut [MultiDOFJointTrajectoryPoint] {
        if self.data.is_null() {
            &mut []
        } else {
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, MultiDOFJointTrajectoryPoint> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, MultiDOFJointTrajectoryPoint> {
...
impl PartialEq for MultiDOFJointTrajectoryPoint {
    fn eq(&self, other: &Self) -> bool {
        unsafe { trajectory_msgs__msg__MultiDOFJointTrajectoryPoint__are_equal(self, other) }
    }
}

impl<const N: usize> PartialEq for MultiDOFJointTrajectoryPointSeq<N> {
    fn eq(&self, other: &Self) -> bool {
        unsafe {
            let msg1 = MultiDOFJointTrajectoryPointSeqRaw {
                data: self.data,
                size: self.size,
                capacity: self.capacity,
            };
            let msg2 = MultiDOFJointTrajectoryPointSeqRaw {
                data: other.data,
                size: other.size,
                capacity: other.capacity,
            };
            trajectory_msgs__msg__MultiDOFJointTrajectoryPoint__Sequence__are_equal(&msg1, &msg2)
        }
    }
}
