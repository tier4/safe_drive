...
extern "C" {
    fn visualization_msgs__msg__InteractiveMarkerPose__init(
        msg: *mut InteractiveMarkerPose,
    ) -> bool;
    fn visualization_msgs__msg__InteractiveMarkerPose__fini(msg: *mut InteractiveMarkerPose);
    fn visualization_msgs__msg__InteractiveMarkerPose__are_equal(
        lhs: *const InteractiveMarkerPose,
        rhs: *const InteractiveMarkerPose,
    ) -> bool;
    fn visualization_msgs__msg__InteractiveMarkerPose__Sequence__init(
        msg: *mut InteractiveMarkerPoseSeqRaw,
        size: usize,
    ) -> bool;
    fn visualization_msgs__msg__InteractiveMarkerPose__Sequence__fini(
        msg: *mut InteractiveMarkerPoseSeqRaw,
    );
    fn visualization_msgs__msg__InteractiveMarkerPose__Sequence__are_equal(
        lhs: *const InteractiveMarkerPoseSeqRaw,
        rhs: *const InteractiveMarkerPoseSeqRaw,
    ) -> bool;
    fn rosidl_typesupport_c__get_message_type_support_handle__visualization_msgs__msg__InteractiveMarkerPose(
...
impl<const N: usize> InteractiveMarkerPoseSeq<N> {
    ...
    pub fn new(size: usize) -> Option<Self> {
        ...
        let mut msg: InteractiveMarkerPoseSeqRaw =
    ...
    pub fn null() -> Self {
        let msg: InteractiveMarkerPoseSeqRaw =
            unsafe { std::mem::MaybeUninit::zeroed().assume_init() };
        Self {
            data: msg.data,
            size: msg.size,
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, InteractiveMarkerPose> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, InteractiveMarkerPose> {
...
impl PartialEq for InteractiveMarkerPose {
    fn eq(&self, other: &Self) -> bool {
        unsafe { visualization_msgs__msg__InteractiveMarkerPose__are_equal(self, other) }
    }
}
...
impl<const N: usize> PartialEq for InteractiveMarkerPoseSeq<N> {
    fn eq(&self, other: &Self) -> bool {
        unsafe {
            let msg1 = InteractiveMarkerPoseSeqRaw {
                data: self.data,
                size: self.size,
                capacity: self.capacity,
            };
            let msg2 = InteractiveMarkerPoseSeqRaw {
                data: other.data,
                size: other.size,
