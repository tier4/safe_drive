...
extern "C" {
    ...
    fn shape_msgs__msg__Plane__Sequence__are_equal(
        lhs: *const PlaneSeqRaw,
        rhs: *const PlaneSeqRaw,
    ) -> bool;
    fn rosidl_typesupport_c__get_message_type_support_handle__shape_msgs__msg__Plane(
...
impl<const N: usize> PlaneSeq<N> {
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, Plane> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, Plane> {
...
impl PartialEq for Plane {
    fn eq(&self, other: &Self) -> bool {
        unsafe { shape_msgs__msg__Plane__are_equal(self, other) }
    }
}
...
impl<const N: usize> PartialEq for PlaneSeq<N> {
    fn eq(&self, other: &Self) -> bool {
        unsafe {
            let msg1 = PlaneSeqRaw {
                data: self.data,
                size: self.size,
                capacity: self.capacity,
            };
            let msg2 = PlaneSeqRaw {
                data: other.data,
                size: other.size,
