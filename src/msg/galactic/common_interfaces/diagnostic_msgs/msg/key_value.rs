...
extern "C" {
    ...
    fn diagnostic_msgs__msg__KeyValue__are_equal(
        lhs: *const KeyValue,
        rhs: *const KeyValue,
    ) -> bool;
    fn diagnostic_msgs__msg__KeyValue__Sequence__init(
        msg: *mut KeyValueSeqRaw,
        size: usize,
    ) -> bool;
    fn diagnostic_msgs__msg__KeyValue__Sequence__fini(msg: *mut KeyValueSeqRaw);
    fn diagnostic_msgs__msg__KeyValue__Sequence__are_equal(
        lhs: *const KeyValueSeqRaw,
        rhs: *const KeyValueSeqRaw,
    ) -> bool;
    fn rosidl_typesupport_c__get_message_type_support_handle__diagnostic_msgs__msg__KeyValue(
...
impl<const N: usize> KeyValueSeq<N> {
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, KeyValue> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, KeyValue> {
...
impl PartialEq for KeyValue {
    fn eq(&self, other: &Self) -> bool {
        unsafe { diagnostic_msgs__msg__KeyValue__are_equal(self, other) }
    }
}
