...
extern "C" {
    ...
    fn lifecycle_msgs__msg__TransitionEvent__are_equal(
        lhs: *const TransitionEvent,
        rhs: *const TransitionEvent,
    ) -> bool;
    fn lifecycle_msgs__msg__TransitionEvent__Sequence__init(
        msg: *mut TransitionEventSeqRaw,
        size: usize,
    ) -> bool;
    fn lifecycle_msgs__msg__TransitionEvent__Sequence__fini(msg: *mut TransitionEventSeqRaw);
    fn lifecycle_msgs__msg__TransitionEvent__Sequence__are_equal(
        lhs: *const TransitionEventSeqRaw,
        rhs: *const TransitionEventSeqRaw,
    ) -> bool;
...
impl<const N: usize> TransitionEventSeq<N> {
    ...
    pub fn new(size: usize) -> Option<Self> {
        ...
        let mut msg: TransitionEventSeqRaw =
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, TransitionEvent> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, TransitionEvent> {
...
impl PartialEq for TransitionEvent {
    fn eq(&self, other: &Self) -> bool {
        unsafe { lifecycle_msgs__msg__TransitionEvent__are_equal(self, other) }
    }
}
...
impl<const N: usize> PartialEq for TransitionEventSeq<N> {
    fn eq(&self, other: &Self) -> bool {
        unsafe {
            let msg1 = TransitionEventSeqRaw {
                data: self.data,
                size: self.size,
                capacity: self.capacity,
            };
            let msg2 = TransitionEventSeqRaw {
                data: other.data,
                size: other.size,
