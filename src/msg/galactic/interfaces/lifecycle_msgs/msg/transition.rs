...
extern "C" {
    ...
    fn lifecycle_msgs__msg__Transition__are_equal(
        lhs: *const Transition,
        rhs: *const Transition,
    ) -> bool;
    fn lifecycle_msgs__msg__Transition__Sequence__init(
        msg: *mut TransitionSeqRaw,
        size: usize,
    ) -> bool;
    fn lifecycle_msgs__msg__Transition__Sequence__fini(msg: *mut TransitionSeqRaw);
    fn lifecycle_msgs__msg__Transition__Sequence__are_equal(
        lhs: *const TransitionSeqRaw,
        rhs: *const TransitionSeqRaw,
    ) -> bool;
...
impl<const N: usize> TransitionSeq<N> {
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, Transition> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, Transition> {
...
impl PartialEq for Transition {
    fn eq(&self, other: &Self) -> bool {
        unsafe { lifecycle_msgs__msg__Transition__are_equal(self, other) }
    }
}
...
impl<const N: usize> PartialEq for TransitionSeq<N> {
    fn eq(&self, other: &Self) -> bool {
        unsafe {
            let msg1 = TransitionSeqRaw {
                data: self.data,
                size: self.size,
                capacity: self.capacity,
            };
            let msg2 = TransitionSeqRaw {
                data: other.data,
                size: other.size,
