...
extern "C" {
    ...
    fn action_msgs__msg__GoalStatusArray__fini(msg: *mut GoalStatusArray);
    fn action_msgs__msg__GoalStatusArray__are_equal(lhs: *const GoalStatusArray, rhs: *const GoalStatusArray) -> bool;
    fn action_msgs__msg__GoalStatusArray__Sequence__init(msg: *mut GoalStatusArraySeqRaw, size: usize) -> bool;
    fn action_msgs__msg__GoalStatusArray__Sequence__fini(msg: *mut GoalStatusArraySeqRaw);
    fn action_msgs__msg__GoalStatusArray__Sequence__are_equal(lhs: *const GoalStatusArraySeqRaw, rhs: *const GoalStatusArraySeqRaw) -> bool;
    fn rosidl_typesupport_c__get_message_type_support_handle__action_msgs__msg__GoalStatusArray() -> *const rcl::rosidl_message_type_support_t;
}
...
impl GoalStatusArray {
    pub fn new() -> Option<Self> {
        ...
        if unsafe { action_msgs__msg__GoalStatusArray__init(&mut msg) } {
            Some(msg)
        } else {
            None
        }
...
impl Drop for GoalStatusArray {
    fn drop(&mut self) {
        unsafe { action_msgs__msg__GoalStatusArray__fini(self) };
    }
}
...
impl<const N: usize> GoalStatusArraySeq<N> {
    ...
    pub fn new(size: usize) -> Option<Self> {
        ...
        if unsafe { action_msgs__msg__GoalStatusArray__Sequence__init(&mut msg, size) } {
...
impl<const N: usize> Drop for GoalStatusArraySeq<N> {
    fn drop(&mut self) {
        ...
        unsafe { action_msgs__msg__GoalStatusArray__Sequence__fini(&mut msg) };
    }
}
...
impl PartialEq for GoalStatusArray {
    fn eq(&self, other: &Self) -> bool {
        unsafe {
            action_msgs__msg__GoalStatusArray__are_equal(self, other)
        }
    }
}
...
impl<const N: usize> PartialEq for GoalStatusArraySeq<N> {
    fn eq(&self, other: &Self) -> bool {
        unsafe {
            ...
            action_msgs__msg__GoalStatusArray__Sequence__are_equal(&msg1, &msg2)
        }
    }
}
