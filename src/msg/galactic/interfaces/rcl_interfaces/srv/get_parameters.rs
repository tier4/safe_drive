...
extern "C" {
    ...
    fn rcl_interfaces__srv__GetParameters_Request__Sequence__init(
        msg: *mut GetParametersRequestSeqRaw,
        size: usize,
    ) -> bool;
    ...
    fn rcl_interfaces__srv__GetParameters_Response__Sequence__init(
        msg: *mut GetParametersResponseSeqRaw,
        size: usize,
    ) -> bool;
...
impl<const N: usize> GetParametersRequestSeq<N> {
    ...
    pub fn new(size: usize) -> Option<Self> {
        ...
        let mut msg: GetParametersRequestSeqRaw =
    ...
    pub fn null() -> Self {
        let msg: GetParametersRequestSeqRaw =
            unsafe { std::mem::MaybeUninit::zeroed().assume_init() };
        Self {
            data: msg.data,
            size: msg.size,
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, GetParametersRequest> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, GetParametersRequest> {
...
impl<const N: usize> GetParametersResponseSeq<N> {
    ...
    pub fn new(size: usize) -> Option<Self> {
        ...
        let mut msg: GetParametersResponseSeqRaw =
            unsafe { std::mem::MaybeUninit::zeroed().assume_init() };
    ...
    pub fn null() -> Self {
        let msg: GetParametersResponseSeqRaw =
            unsafe { std::mem::MaybeUninit::zeroed().assume_init() };
        Self {
            data: msg.data,
            size: msg.size,
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, GetParametersResponse> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, GetParametersResponse> {
        self.as_slice_mut().iter_mut()
    }
