...
extern "C" {
    ...
    fn rcl_interfaces__srv__ListParameters_Request__Sequence__init(
        msg: *mut ListParametersRequestSeqRaw,
        size: usize,
    ) -> bool;
    fn rcl_interfaces__srv__ListParameters_Request__Sequence__fini(
        msg: *mut ListParametersRequestSeqRaw,
    );
    fn rcl_interfaces__srv__ListParameters_Response__init(msg: *mut ListParametersResponse)
        -> bool;
    ...
    fn rcl_interfaces__srv__ListParameters_Response__Sequence__init(
        msg: *mut ListParametersResponseSeqRaw,
        size: usize,
    ) -> bool;
...
impl<const N: usize> ListParametersRequestSeq<N> {
    ...
    pub fn new(size: usize) -> Option<Self> {
        ...
        let mut msg: ListParametersRequestSeqRaw =
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, ListParametersRequest> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, ListParametersRequest> {
...
impl<const N: usize> ListParametersResponseSeq<N> {
    ...
    pub fn new(size: usize) -> Option<Self> {
        ...
        let mut msg: ListParametersResponseSeqRaw =
            unsafe { std::mem::MaybeUninit::zeroed().assume_init() };
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, ListParametersResponse> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, ListParametersResponse> {
        self.as_slice_mut().iter_mut()
    }
