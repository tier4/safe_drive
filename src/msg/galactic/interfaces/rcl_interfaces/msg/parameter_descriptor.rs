...
extern "C" {
    ...
    fn rcl_interfaces__msg__ParameterDescriptor__are_equal(lhs: *const ParameterDescriptor, rhs: *const ParameterDescriptor) -> bool;
    fn rcl_interfaces__msg__ParameterDescriptor__Sequence__init(msg: *mut ParameterDescriptorSeqRaw, size: usize) -> bool;
    fn rcl_interfaces__msg__ParameterDescriptor__Sequence__fini(msg: *mut ParameterDescriptorSeqRaw);
    fn rcl_interfaces__msg__ParameterDescriptor__Sequence__are_equal(lhs: *const ParameterDescriptorSeqRaw, rhs: *const ParameterDescriptorSeqRaw) -> bool;
    fn rosidl_typesupport_c__get_message_type_support_handle__rcl_interfaces__msg__ParameterDescriptor() -> *const rcl::rosidl_message_type_support_t;
}
...
impl<const N: usize> ParameterDescriptorSeq<N> {
    ...
    pub fn new(size: usize) -> Option<Self> {
        ...
        let mut msg: ParameterDescriptorSeqRaw = unsafe { std::mem::MaybeUninit::zeroed().assume_init() };
    ...
    pub fn null() -> Self {
        let msg: ParameterDescriptorSeqRaw = unsafe { std::mem::MaybeUninit::zeroed().assume_init() };
...
impl<const N: usize> Drop for ParameterDescriptorSeq<N> {
    fn drop(&mut self) {
        let mut msg = ParameterDescriptorSeqRaw{data: self.data, size: self.size, capacity: self.capacity};
...
impl PartialEq for ParameterDescriptor {
    fn eq(&self, other: &Self) -> bool {
        unsafe {
            rcl_interfaces__msg__ParameterDescriptor__are_equal(self, other)
        }
    }
}
...
impl<const N: usize> PartialEq for ParameterDescriptorSeq<N> {
    fn eq(&self, other: &Self) -> bool {
        unsafe {
            let msg1 = ParameterDescriptorSeqRaw{data: self.data, size: self.size, capacity: self.capacity};
            let msg2 = ParameterDescriptorSeqRaw{data: other.data, size: other.size, capacity: other.capacity};
