...
extern "C" {
    ...
    fn rcl_interfaces__msg__Log__Sequence__are_equal(
        lhs: *const LogSeqRaw,
        rhs: *const LogSeqRaw,
    ) -> bool;
...
impl<const N: usize> LogSeq<N> {
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, Log> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, Log> {
...
impl PartialEq for Log {
    fn eq(&self, other: &Self) -> bool {
        unsafe { rcl_interfaces__msg__Log__are_equal(self, other) }
    }
}
