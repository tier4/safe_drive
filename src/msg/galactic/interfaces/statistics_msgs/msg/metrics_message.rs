...
extern "C" {
    ...
    fn statistics_msgs__msg__MetricsMessage__are_equal(
        lhs: *const MetricsMessage,
        rhs: *const MetricsMessage,
    ) -> bool;
    fn statistics_msgs__msg__MetricsMessage__Sequence__init(
        msg: *mut MetricsMessageSeqRaw,
        size: usize,
    ) -> bool;
    fn statistics_msgs__msg__MetricsMessage__Sequence__fini(msg: *mut MetricsMessageSeqRaw);
    fn statistics_msgs__msg__MetricsMessage__Sequence__are_equal(
        lhs: *const MetricsMessageSeqRaw,
        rhs: *const MetricsMessageSeqRaw,
    ) -> bool;
    fn rosidl_typesupport_c__get_message_type_support_handle__statistics_msgs__msg__MetricsMessage(
...
impl<const N: usize> MetricsMessageSeq<N> {
    ...
    pub fn new(size: usize) -> Option<Self> {
        ...
        let mut msg: MetricsMessageSeqRaw =
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, MetricsMessage> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, MetricsMessage> {
...
impl PartialEq for MetricsMessage {
    fn eq(&self, other: &Self) -> bool {
        unsafe { statistics_msgs__msg__MetricsMessage__are_equal(self, other) }
    }
}
...
impl<const N: usize> PartialEq for MetricsMessageSeq<N> {
    fn eq(&self, other: &Self) -> bool {
        unsafe {
            let msg1 = MetricsMessageSeqRaw {
                data: self.data,
                size: self.size,
                capacity: self.capacity,
            };
            let msg2 = MetricsMessageSeqRaw {
                data: other.data,
                size: other.size,
