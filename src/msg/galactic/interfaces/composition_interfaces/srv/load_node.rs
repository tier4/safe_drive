...
extern "C" {
    ...
    fn composition_interfaces__srv__LoadNode_Request__Sequence__init(
        msg: *mut LoadNodeRequestSeqRaw,
        size: usize,
    ) -> bool;
    fn composition_interfaces__srv__LoadNode_Request__Sequence__fini(
        msg: *mut LoadNodeRequestSeqRaw,
    );
    ...
    fn composition_interfaces__srv__LoadNode_Response__Sequence__init(
        msg: *mut LoadNodeResponseSeqRaw,
        size: usize,
    ) -> bool;
    fn composition_interfaces__srv__LoadNode_Response__Sequence__fini(
        msg: *mut LoadNodeResponseSeqRaw,
    );
...
impl<const N: usize> LoadNodeRequestSeq<N> {
    ...
    pub fn new(size: usize) -> Option<Self> {
        ...
        let mut msg: LoadNodeRequestSeqRaw =
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, LoadNodeRequest> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, LoadNodeRequest> {
...
impl<const N: usize> LoadNodeResponseSeq<N> {
    ...
    pub fn new(size: usize) -> Option<Self> {
        ...
        let mut msg: LoadNodeResponseSeqRaw =
            unsafe { std::mem::MaybeUninit::zeroed().assume_init() };
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, LoadNodeResponse> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, LoadNodeResponse> {
        self.as_slice_mut().iter_mut()
    }
