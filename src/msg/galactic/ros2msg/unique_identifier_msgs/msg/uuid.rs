...
extern "C" {
    ...
    fn unique_identifier_msgs__msg__UUID__Sequence__init(msg: *mut UUIDSeqRaw, size: usize)
        -> bool;
    fn unique_identifier_msgs__msg__UUID__Sequence__fini(msg: *mut UUIDSeqRaw);
    fn unique_identifier_msgs__msg__UUID__Sequence__are_equal(
        lhs: *const UUIDSeqRaw,
        rhs: *const UUIDSeqRaw,
    ) -> bool;
...
impl<const N: usize> UUIDSeq<N> {
    ...
    pub fn iter<'a>(&'a self) -> std::slice::Iter<'a, UUID> {
        self.as_slice().iter()
    }

    pub fn iter_mut<'a>(&'a mut self) -> std::slice::IterMut<'a, UUID> {
...
impl PartialEq for UUID {
    fn eq(&self, other: &Self) -> bool {
        unsafe { unique_identifier_msgs__msg__UUID__are_equal(self, other) }
    }
}
