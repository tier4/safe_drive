...
extern "C" {
    ...
    fn visualization_msgs__msg__MeshFile__are_equal(
        lhs: *const MeshFile,
        rhs: *const MeshFile,
    ) -> bool;
    fn visualization_msgs__msg__MeshFile__Sequence__init(
        msg: *mut MeshFileSeqRaw,
        size: usize,
    ) -> bool;
    fn visualization_msgs__msg__MeshFile__Sequence__fini(msg: *mut MeshFileSeqRaw);
    fn visualization_msgs__msg__MeshFile__Sequence__are_equal(
        lhs: *const MeshFileSeqRaw,
        rhs: *const MeshFileSeqRaw,
    ) -> bool;
    fn rosidl_typesupport_c__get_message_type_support_handle__visualization_msgs__msg__MeshFile(
...
impl PartialEq for MeshFile {
    fn eq(&self, other: &Self) -> bool {
        unsafe { visualization_msgs__msg__MeshFile__are_equal(self, other) }
    }
}
...
impl<const N: usize> PartialEq for MeshFileSeq<N> {
    fn eq(&self, other: &Self) -> bool {
        unsafe {
            let msg1 = MeshFileSeqRaw {
                data: self.data,
                size: self.size,
                capacity: self.capacity,
            };
            let msg2 = MeshFileSeqRaw {
                data: other.data,
                size: other.size,
