...
extern "C" {
    ...
    fn action_msgs__msg__GoalStatusArray__are_equal(
    ...
    fn action_msgs__msg__GoalStatusArray__Sequence__are_equal(
...
impl PartialEq for GoalStatusArray {
    fn eq(&self, other: &Self) -> bool {
        unsafe { action_msgs__msg__GoalStatusArray__are_equal(self, other) }
    }
}
