...
use crate::msg::*;
use crate::rcl;
pub const STATUS_UNKNOWN: i8 = -2; // status is not yet set
...
pub const SERVICE_UNKNOWN: u16 = 0; // Remember service is a bitfield, so checking (service & SERVICE_UNKNOWN) will not work. Use == instead.
...
extern "C" {
    ...
    fn sensor_msgs__msg__NavSatStatus__are_equal(
        lhs: *const NavSatStatus,
        rhs: *const NavSatStatus,
    ) -> bool;
    fn sensor_msgs__msg__NavSatStatus__Sequence__init(
        msg: *mut NavSatStatusSeqRaw,
        size: usize,
    ) -> bool;
    fn sensor_msgs__msg__NavSatStatus__Sequence__fini(msg: *mut NavSatStatusSeqRaw);
    fn sensor_msgs__msg__NavSatStatus__Sequence__are_equal(
        lhs: *const NavSatStatusSeqRaw,
        rhs: *const NavSatStatusSeqRaw,
    ) -> bool;
...
impl<const N: usize> Drop for NavSatStatusSeq<N> {
    fn drop(&mut self) {
        let mut msg = NavSatStatusSeqRaw {
            data: self.data,
            size: self.size,
...
impl PartialEq for NavSatStatus {
    fn eq(&self, other: &Self) -> bool {
        unsafe { sensor_msgs__msg__NavSatStatus__are_equal(self, other) }
    }
}
...
impl<const N: usize> PartialEq for NavSatStatusSeq<N> {
    fn eq(&self, other: &Self) -> bool {
        unsafe {
            let msg1 = NavSatStatusSeqRaw {
                data: self.data,
                size: self.size,
                capacity: self.capacity,
            };
            let msg2 = NavSatStatusSeqRaw {
                data: other.data,
                size: other.size,
