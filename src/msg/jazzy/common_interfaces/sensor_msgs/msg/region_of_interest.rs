...
extern "C" {
    ...
    fn sensor_msgs__msg__RegionOfInterest__are_equal(
        lhs: *const RegionOfInterest,
        rhs: *const RegionOfInterest,
    ) -> bool;
    fn sensor_msgs__msg__RegionOfInterest__Sequence__init(
        msg: *mut RegionOfInterestSeqRaw,
        size: usize,
    ) -> bool;
    fn sensor_msgs__msg__RegionOfInterest__Sequence__fini(msg: *mut RegionOfInterestSeqRaw);
    fn sensor_msgs__msg__RegionOfInterest__Sequence__are_equal(
        lhs: *const RegionOfInterestSeqRaw,
        rhs: *const RegionOfInterestSeqRaw,
    ) -> bool;
...
impl<const N: usize> RegionOfInterestSeq<N> {
    ...
    pub fn new(size: usize) -> Option<Self> {
        ...
        let mut msg: RegionOfInterestSeqRaw =
...
impl PartialEq for RegionOfInterest {
    fn eq(&self, other: &Self) -> bool {
        unsafe { sensor_msgs__msg__RegionOfInterest__are_equal(self, other) }
    }
}
...
impl<const N: usize> PartialEq for RegionOfInterestSeq<N> {
    fn eq(&self, other: &Self) -> bool {
        unsafe {
            let msg1 = RegionOfInterestSeqRaw {
                data: self.data,
                size: self.size,
                capacity: self.capacity,
            };
            let msg2 = RegionOfInterestSeqRaw {
                data: other.data,
                size: other.size,
