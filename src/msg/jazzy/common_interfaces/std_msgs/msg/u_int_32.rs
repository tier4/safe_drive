...
extern "C" {
    ...
    fn std_msgs__msg__UInt32__Sequence__are_equal(
        lhs: *const UInt32SeqRaw,
        rhs: *const UInt32SeqRaw,
    ) -> bool;
...
impl PartialEq for UInt32 {
    fn eq(&self, other: &Self) -> bool {
        unsafe { std_msgs__msg__UInt32__are_equal(self, other) }
    }
}
...
impl<const N: usize> PartialEq for UInt32Seq<N> {
    fn eq(&self, other: &Self) -> bool {
        unsafe {
            let msg1 = UInt32SeqRaw {
                data: self.data,
                size: self.size,
                capacity: self.capacity,
            };
            let msg2 = UInt32SeqRaw {
                data: other.data,
                size: other.size,
