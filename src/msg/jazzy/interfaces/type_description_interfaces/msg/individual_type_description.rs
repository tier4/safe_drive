...
extern "C" {
    fn type_description_interfaces__msg__IndividualTypeDescription__init(
        msg: *mut IndividualTypeDescription,
    ) -> bool;
    fn type_description_interfaces__msg__IndividualTypeDescription__fini(
        msg: *mut IndividualTypeDescription,
    );
    fn type_description_interfaces__msg__IndividualTypeDescription__are_equal(
        lhs: *const IndividualTypeDescription,
        rhs: *const IndividualTypeDescription,
    ) -> bool;
    fn type_description_interfaces__msg__IndividualTypeDescription__Sequence__init(
        msg: *mut IndividualTypeDescriptionSeqRaw,
        size: usize,
    ) -> bool;
    fn type_description_interfaces__msg__IndividualTypeDescription__Sequence__fini(
        msg: *mut IndividualTypeDescriptionSeqRaw,
    );
    fn type_description_interfaces__msg__IndividualTypeDescription__Sequence__are_equal(
        lhs: *const IndividualTypeDescriptionSeqRaw,
        rhs: *const IndividualTypeDescriptionSeqRaw,
    ) -> bool;
    fn rosidl_typesupport_c__get_message_type_support_handle__type_description_interfaces__msg__IndividualTypeDescription(
...
impl<const N: usize> IndividualTypeDescriptionSeq<N> {
    ...
    pub fn new(size: usize) -> Option<Self> {
        ...
        let mut msg: IndividualTypeDescriptionSeqRaw =
    ...
    pub fn null() -> Self {
        let msg: IndividualTypeDescriptionSeqRaw =
            unsafe { std::mem::MaybeUninit::zeroed().assume_init() };
        Self {
            data: msg.data,
            size: msg.size,
...
impl<const N: usize> Drop for IndividualTypeDescriptionSeq<N> {
    fn drop(&mut self) {
        ...
        unsafe {
            type_description_interfaces__msg__IndividualTypeDescription__Sequence__fini(&mut msg)
        };
    }
}
...
impl<const N: usize> PartialEq for IndividualTypeDescriptionSeq<N> {
    fn eq(&self, other: &Self) -> bool {
        unsafe {
            let msg1 = IndividualTypeDescriptionSeqRaw {
                data: self.data,
                size: self.size,
                capacity: self.capacity,
            };
            let msg2 = IndividualTypeDescriptionSeqRaw {
                data: other.data,
                size: other.size,
                capacity: other.capacity,
            };
            type_description_interfaces__msg__IndividualTypeDescription__Sequence__are_equal(
                &msg1, &msg2,
            )
        }
    }
