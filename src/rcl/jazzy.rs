...
pub const RCUTILS_LOG_MIN_SEVERITY_DEBUG: u32 = 0;
pub const RCUTILS_LOG_MIN_SEVERITY_INFO: u32 = 1;
pub const RCUTILS_LOG_MIN_SEVERITY_WARN: u32 = 2;
pub const RCUTILS_LOG_MIN_SEVERITY_ERROR: u32 = 3;
pub const RCUTILS_LOG_MIN_SEVERITY_FATAL: u32 = 4;
pub const RCUTILS_LOG_MIN_SEVERITY_NONE: u32 = 5;
pub const RCUTILS_LOG_MIN_SEVERITY: u32 = 0;
...
pub type RclLogFilter = ::std::option::Option<unsafe extern "C" fn() -> bool>;
...
#[test]
fn bindgen_test_layout_rcl_timer_call_info_s() {
    const UNINIT: ::std::mem::MaybeUninit<rcl_timer_call_info_s> =
        ::std::mem::MaybeUninit::uninit();
    let ptr = UNINIT.as_ptr();
    assert_eq!(
        ::std::mem::size_of::<rcl_timer_call_info_s>(),
        16usize,
        concat!("Size of: ", stringify!(rcl_timer_call_info_s))
    );
    assert_eq!(
        ::std::mem::align_of::<rcl_timer_call_info_s>(),
        8usize,
        concat!("Alignment of ", stringify!(rcl_timer_call_info_s))
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).expected_call_time) as usize - ptr as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(rcl_timer_call_info_s),
            "::",
            stringify!(expected_call_time)
        )
    );
    assert_eq!(
        unsafe { ::std::ptr::addr_of!((*ptr).actual_call_time) as usize - ptr as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(rcl_timer_call_info_s),
            "::",
            stringify!(actual_call_time)
        )
    );
}
...
extern "C" {
    pub fn bindgen_action_msgs__msg__GoalInfo__are_equal(
        lhs: *const bindgen_action_msgs__msg__GoalInfo,
        rhs: *const bindgen_action_msgs__msg__GoalInfo,
    ) -> bool;
}
extern "C" {
    pub fn bindgen_action_msgs__msg__GoalInfo__copy(
        input: *const bindgen_action_msgs__msg__GoalInfo,
        output: *mut bindgen_action_msgs__msg__GoalInfo,
    ) -> bool;
}
extern "C" {
    pub fn bindgen_action_msgs__msg__GoalInfo__get_type_hash(
        type_support: *const rosidl_message_type_support_t,
    ) -> *const rosidl_type_hash_t;
}
extern "C" {
    pub fn bindgen_action_msgs__msg__GoalInfo__get_type_description(
        type_support: *const rosidl_message_type_support_t,
    ) -> *const rosidl_runtime_c__type_description__TypeDescription;
}
extern "C" {
    pub fn bindgen_action_msgs__msg__GoalInfo__get_individual_type_description_source(
        type_support: *const rosidl_message_type_support_t,
    ) -> *const rosidl_runtime_c__type_description__TypeSource;
}
extern "C" {
    pub fn bindgen_action_msgs__msg__GoalInfo__get_type_description_sources(
        type_support: *const rosidl_message_type_support_t,
    ) -> *const rosidl_runtime_c__type_description__TypeSource__Sequence;
}
extern "C" {
    pub fn bindgen_action_msgs__msg__GoalInfo__Sequence__init(
        array: *mut bindgen_action_msgs__msg__GoalInfo__Sequence,
        size: usize,
    ) -> bool;
}
extern "C" {
    pub fn bindgen_action_msgs__msg__GoalInfo__Sequence__fini(
        array: *mut bindgen_action_msgs__msg__GoalInfo__Sequence,
    );
}
extern "C" {
    pub fn bindgen_action_msgs__msg__GoalInfo__Sequence__create(
        size: usize,
    ) -> *mut bindgen_action_msgs__msg__GoalInfo__Sequence;
}
extern "C" {
    pub fn bindgen_action_msgs__msg__GoalInfo__Sequence__destroy(
        array: *mut bindgen_action_msgs__msg__GoalInfo__Sequence,
    );
}
extern "C" {
    pub fn bindgen_action_msgs__msg__GoalInfo__Sequence__are_equal(
        lhs: *const bindgen_action_msgs__msg__GoalInfo__Sequence,
        rhs: *const bindgen_action_msgs__msg__GoalInfo__Sequence,
    ) -> bool;
}
extern "C" {
    pub fn bindgen_action_msgs__msg__GoalInfo__Sequence__copy(
        input: *const bindgen_action_msgs__msg__GoalInfo__Sequence,
        output: *mut bindgen_action_msgs__msg__GoalInfo__Sequence,
    ) -> bool;
}
extern "C" {
    pub fn rosidl_typesupport_c__get_message_type_support_handle__bindgen_action_msgs__msg__GoalInfo(
    ) -> *const rosidl_message_type_support_t;
}
...
extern "C" {
    pub fn bindgen_action_msgs__srv__CancelGoal_Request__init(
        msg: *mut bindgen_action_msgs__srv__CancelGoal_Request,
    ) -> bool;
}
extern "C" {
    pub fn bindgen_action_msgs__srv__CancelGoal_Request__fini(
        msg: *mut bindgen_action_msgs__srv__CancelGoal_Request,
    );
}
extern "C" {
    pub fn bindgen_action_msgs__srv__CancelGoal_Request__create(
    ) -> *mut bindgen_action_msgs__srv__CancelGoal_Request;
}
extern "C" {
    pub fn bindgen_action_msgs__srv__CancelGoal_Request__destroy(
        msg: *mut bindgen_action_msgs__srv__CancelGoal_Request,
    );
}
extern "C" {
    pub fn bindgen_action_msgs__srv__CancelGoal_Request__are_equal(
        lhs: *const bindgen_action_msgs__srv__CancelGoal_Request,
        rhs: *const bindgen_action_msgs__srv__CancelGoal_Request,
    ) -> bool;
}
extern "C" {
    pub fn bindgen_action_msgs__srv__CancelGoal_Request__copy(
        input: *const bindgen_action_msgs__srv__CancelGoal_Request,
        output: *mut bindgen_action_msgs__srv__CancelGoal_Request,
    ) -> bool;
}
extern "C" {
    pub fn bindgen_action_msgs__srv__CancelGoal_Request__get_type_hash(
        type_support: *const rosidl_message_type_support_t,
    ) -> *const rosidl_type_hash_t;
}
extern "C" {
    pub fn bindgen_action_msgs__srv__CancelGoal_Request__get_type_description(
        type_support: *const rosidl_message_type_support_t,
    ) -> *const rosidl_runtime_c__type_description__TypeDescription;
}
extern "C" {
    pub fn bindgen_action_msgs__srv__CancelGoal_Request__get_individual_type_description_source(
        type_support: *const rosidl_message_type_support_t,
    ) -> *const rosidl_runtime_c__type_description__TypeSource;
}
extern "C" {
    pub fn bindgen_action_msgs__srv__CancelGoal_Request__get_type_description_sources(
        type_support: *const rosidl_message_type_support_t,
    ) -> *const rosidl_runtime_c__type_description__TypeSource__Sequence;
}
extern "C" {
    pub fn bindgen_action_msgs__srv__CancelGoal_Request__Sequence__init(
        array: *mut bindgen_action_msgs__srv__CancelGoal_Request__Sequence,
        size: usize,
    ) -> bool;
}
extern "C" {
    pub fn bindgen_action_msgs__srv__CancelGoal_Request__Sequence__fini(
        array: *mut bindgen_action_msgs__srv__CancelGoal_Request__Sequence,
    );
}
extern "C" {
    pub fn bindgen_action_msgs__srv__CancelGoal_Request__Sequence__create(
        size: usize,
    ) -> *mut bindgen_action_msgs__srv__CancelGoal_Request__Sequence;
}
extern "C" {
    pub fn bindgen_action_msgs__srv__CancelGoal_Request__Sequence__destroy(
        array: *mut bindgen_action_msgs__srv__CancelGoal_Request__Sequence,
    );
}
extern "C" {
    pub fn bindgen_action_msgs__srv__CancelGoal_Request__Sequence__are_equal(
        lhs: *const bindgen_action_msgs__srv__CancelGoal_Request__Sequence,
        rhs: *const bindgen_action_msgs__srv__CancelGoal_Request__Sequence,
    ) -> bool;
}
extern "C" {
    pub fn bindgen_action_msgs__srv__CancelGoal_Request__Sequence__copy(
        input: *const bindgen_action_msgs__srv__CancelGoal_Request__Sequence,
        output: *mut bindgen_action_msgs__srv__CancelGoal_Request__Sequence,
    ) -> bool;
}
extern "C" {
...
extern "C" {
    pub fn rosidl_typesupport_c__get_message_type_support_handle__bindgen_action_msgs__srv__CancelGoal_Request(
    ) -> *const rosidl_message_type_support_t;
}
extern "C" {
