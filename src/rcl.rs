//! This includes function definitions automatically generated by rust-bindgen from ROS2's header files.
//!
//! ```text
//! $ bindgen /opt/ros/galactic/include/rcl/rcl.h -- -I /opt/ros/galactic/include > safe_drive/src/rcl/galactic.rs
//! ```
